...
export default function AcademyStoreAdmin({ userData }: { userData: any }) {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex bg-gray-100 dark:bg-[#090D16] p-1 rounded-xl">
            <button
        ...
        {activeTab === 'categories' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-[#090D16] p-5 rounded-2xl border border-gray-100 dark:border-slate-800">
              ...
              <form onSubmit={handleAddCategory} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2.5 outline-none focus:border-purple-500 dark:text-white text-sm font-bold"
            ...
            <div className="space-y-3">
              ...
              {categories.map(cat => (
                <div key={cat.id} className="flex items-center justify-between bg-white dark:bg-[#0D121F] p-4 rounded-xl border border-gray-100 dark:border-slate-800">
                  {editingCategoryId === cat.id ? (
                    <div className="flex items-center gap-2 flex-1 ml-4">
                      <input
                        ...
                        className="flex-1 bg-gray-50 dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-1.5 outline-none focus:border-purple-500 dark:text-white text-sm font-bold"
                        autoFocus
                      />
        ...
        {activeTab === 'items' && (
          <div className="space-y-8">
            <form onSubmit={handleAddItem} className="bg-gray-50 dark:bg-[#090D16] p-5 rounded-2xl border border-gray-100 dark:border-slate-800 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input type="text" value={itemTitle} onChange={(e) => setItemTitle(e.target.value)} className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-purple-500 dark:text-white text-sm font-bold" required />
              </div>
              
              <div>
                <label className="block text-xs font-bold text-gray-500 mb-1">الفئة</label>
                <select value={itemCat} onChange={(e) => setItemCat(e.target.value)} className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-purple-500 dark:text-white text-sm font-bold" required>
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-purple-500 dark:text-white text-sm font-bold file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-bold file:bg-purple-50 file:text-purple-600 hover:file:bg-purple-100 cursor-pointer" 
                />
              </div>

              <div>
                <label className="block text-xs font-bold text-gray-500 mb-1">سعر الشراء (التكلفة)</label>
                <input type="number" value={itemPurchase} onChange={(e) => setItemPurchase(e.target.value)} className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-purple-500 dark:text-white text-sm font-bold font-mono" required />
              </div>

              <div>
                <label className="block text-xs font-bold text-gray-500 mb-1">سعر البيع للطالب</label>
                <input type="number" value={itemSelling} onChange={(e) => setItemSelling(e.target.value)} className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-purple-500 dark:text-white text-sm font-bold font-mono" required />
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-500 mb-1">عدد النسخ (المخزون)</label>
                <input type="number" value={itemStock} onChange={(e) => setItemStock(e.target.value)} className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-purple-500 dark:text-white text-sm font-bold font-mono" required />
              </div>
              
              <div className="lg:col-span-3">
                <label className="block text-xs font-bold text-gray-500 mb-1">وصف الصنف</label>
                <textarea value={itemDesc} onChange={(e) => setItemDesc(e.target.value)} className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-purple-500 dark:text-white text-sm font-bold h-20 resize-none" />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {items.map(item => {
                ...
                return (
                  <div key={item.id} className="bg-white dark:bg-[#0D121F] border border-gray-150 dark:border-slate-800 rounded-2xl overflow-hidden hover:shadow-md transition-shadow group">
                    <div className="h-40 bg-gray-100 dark:bg-[#090D16] relative">
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
              <div className="bg-white dark:bg-[#0D121F] p-3 rounded-2xl border border-gray-100 dark:border-slate-800">
                <div className="flex items-center gap-2">
            ...
            <div className="bg-white dark:bg-[#0D121F] p-5 rounded-2xl border border-gray-100 dark:border-slate-800">
              ...
              <div className="space-y-3">
                {items.sort((a, b) => (b.salesCount || 0) - (a.salesCount || 0)).slice(0, 5).map((item, index) => (
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-[#090D16] rounded-xl border border-gray-100 dark:border-slate-800">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-white dark:bg-[#111827] rounded-lg flex items-center justify-center font-bold text-gray-400">
                        {index + 1}
                      </div>
                      <div className="w-10 h-10 rounded-lg overflow-hidden border border-gray-200 dark:border-slate-800">
                        <img src={item.imageUrl} alt={item.title} className="w-full h-full object-cover" />
                      </div>
                      <div>
        ...
        {activeTab === 'orders' && (
          <div className="bg-white dark:bg-[#0D121F] rounded-2xl border border-gray-100 dark:border-slate-800 overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 dark:bg-[#090D16] text-right">
      ...
      {categoryToDelete && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 md:p-8 max-w-md w-full shadow-2xl relative border border-gray-200 dark:border-slate-800">
