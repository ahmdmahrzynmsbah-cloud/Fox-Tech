...
export default function AdminVisualStats({ users, progressRecords }: AdminVisualStatsProps) {
  ...
  const pieData = useMemo(() => {
    return [
      { name: 'طلاب نشطون', value: activeStudents.length, color: '#D4F800' },
      { name: 'طلاب مؤرشفون', value: archivedStudents.length, color: '#3B82F6' }
    ];
  ...
  if (students.length === 0) {
    return (
      <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 text-center">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {/* Active Card */}
        <div className="bg-white dark:bg-[#111827] p-5 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-950/30 text-sky-600 flex items-center justify-center shrink-0">
          ...
          <span className="text-xs font-bold bg-blue-50 dark:bg-blue-950/50 text-sky-600 py-1 px-2.5 rounded-lg border border-blue-100 dark:border-blue-900/50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm lg:col-span-5 flex flex-col justify-between">
          <div>
          ...
          {/* Custom Legends */}
          <div className="grid grid-cols-2 gap-2 mt-4 pt-4 border-t border-gray-100 dark:border-slate-800">
        ...
        <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm lg:col-span-7 flex flex-col justify-between">
          <div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip 
                  ...
                  labelStyle={{ color: '#0A102E', fontWeight: 'black', marginBottom: '4px' }}
                />
                <Bar 
                ...
                >
                  {gradeChartData.map((entry, index) => (
                    <Cell 
                      key={`cell-${index}`} 
                      fill={entry.name === 'غير محدد' ? '#9CA3AF' : '#D4F800'} 
                    />
                  ))}
                </Bar>
              </BarChart>
