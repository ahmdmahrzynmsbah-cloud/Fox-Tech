...
export default function SpecialRegistration() {
  ...
  const [selectedRegType, setSelectedRegType] = useState<'qudurat' | 'tahsili' | 'both'>(() => {
    if (type === 'qudurat' && isQuduratEnabled) return 'qudurat';
    if (type === 'tahsili' && isTahsiliEnabled) return 'tahsili';
    if (isQuduratEnabled && isTahsiliEnabled) return 'both';
    if (isQuduratEnabled) return 'qudurat';
    return 'tahsili';
  });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#090D16] text-gray-900 dark:text-white flex flex-col items-center justify-center p-4 sm:p-6 font-sans relative">
      <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-10">
        <button onClick={() => navigate('/')} className="text-gray-500 dark:text-gray-400 hover:text-primary flex items-center gap-1.5 transition-colors text-xs sm:text-sm font-black bg-white dark:bg-[#111827] px-4 py-2 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800">
      ...
      >
        <div className="bg-white dark:bg-[#111827] rounded-[2.5rem] p-8 shadow-2xl border border-gray-100 dark:border-slate-800 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative z-10" dir="rtl">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  { id: 'qudurat', label: 'القدرات', colorClass: 'border-emerald-500/20 dark:border-emerald-500/10', show: isQuduratEnabled },
                  { id: 'tahsili', label: 'التحصيلي', colorClass: 'border-purple-500/20 dark:border-purple-500/10', show: isTahsiliEnabled },
                  { id: 'both', label: 'كلاهما', colorClass: 'border-blue-500/20 dark:border-blue-500/10', show: isQuduratEnabled && isTahsiliEnabled },
                  ...
                  return (
                    <button
                      ...
                      className={`py-3 px-1 rounded-xl text-center font-black text-xs border transition-all cursor-pointer ${
                        isSelected 
                          ? activeColor 
                          : 'border-gray-150 dark:border-slate-800 bg-gray-50/50 dark:bg-white/5 text-gray-400 dark:text-gray-500 hover:text-gray-700'
                      }`}
                    >
                      {item.label}
                    </button>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-150 dark:border-slate-800 rounded-2xl pr-12 pl-4 py-3.5 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-xs font-bold"
              ...
              <div className="flex gap-2" dir="ltr">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-150 dark:border-slate-800 rounded-2xl pr-12 pl-4 py-3.5 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-xs font-bold font-mono tracking-wider text-left"
