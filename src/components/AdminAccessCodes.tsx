...
export default function AdminAccessCodes({ userData }: { userData: any }) {
  ...
  return (
    <div className="bg-white dark:bg-[#111827] rounded-3xl p-8 border border-gray-100 dark:border-slate-800/50 shadow-sm relative overflow-hidden mt-6">
      <div className="absolute top-0 right-0 w-32 h-32 bg-[#00B4D8]/5 rounded-full blur-3xl -z-10"></div>
      
      {codeToDelete && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm px-4">
          <div className="bg-white dark:bg-[#111827] rounded-2xl p-6 max-w-sm w-full shadow-2xl border border-gray-100 dark:border-slate-800">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#00B4D8]/20 to-[#0077B6]/20 flex items-center justify-center text-sky-600">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-gray-50 dark:bg-[#090D16]/30 rounded-2xl border border-dashed border-gray-200 dark:border-slate-800">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {codes.map(code => {
            ...
            return (
              <div key={code.id} className={`p-5 rounded-2xl border ${code.used || isExpired ? 'border-gray-200 dark:border-slate-800' : 'border-sky-500/30 dark:border-sky-500/30'} bg-white dark:bg-[#111827] relative group transition-all hover:shadow-md`}>
                ...
                <div className="flex items-center gap-2 mb-4 bg-gray-50 dark:bg-[#090D16] p-3 rounded-xl border border-gray-100 dark:border-slate-800">
                  ...
                  <button
                    ...
                    className="p-2.5 bg-white dark:bg-[#111827] text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-cyan-400 shadow-sm rounded-lg border border-gray-200 dark:border-slate-800 transition-colors"
                    title="نسخ الكود"
                  >
