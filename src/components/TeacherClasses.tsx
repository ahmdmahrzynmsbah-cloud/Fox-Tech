  ...
  if (showManageStudentsModal && selectedCourseForStudents) {
    return (
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm">
          <div>
        ...
        <div className="bg-white dark:bg-[#111827] rounded-3xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm min-h-[500px]">
          {loadingStudents ? (
                  ...
                  {courseStudents.map(student => {
                    ...
                    return (
                      <React.Fragment key={student.id}>
                        <tr className="border-b border-gray-50 dark:border-slate-800 hover:bg-gray-50/50 dark:hover:bg-[#222230]/50 transition-colors">
                          <td className="p-4 min-w-[200px]">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-sky-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 flex items-center justify-center font-black text-white text-lg shadow-md shrink-0">
                          ...
                          <td className="p-4 min-w-[150px]">
                            <div className="flex flex-col gap-1 w-full max-w-[150px]">
                              ...
                              <div className="w-full bg-gray-100 dark:bg-[#1C1C28] rounded-full h-1.5 overflow-hidden">
                                <div 
                                  className="bg-sky-600 dark:bg-cyan-500 h-full rounded-full transition-all duration-500" 
                          ...
                          <td className="p-4 whitespace-nowrap">
                            <div className="flex items-center gap-3">
                              <button 
                                ...
                                className={`relative flex h-7 w-12 items-center rounded-full transition-all duration-300 ${!isSuspended ? 'bg-gradient-to-l from-sky-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 shadow-inner shadow-blue-500/20' : 'bg-gray-200 dark:bg-[#3D3D4D] shadow-inner'}`}
                              ...
                              >
                                ...
                                >
                                  <motion.div
                                    ...
                                    className="w-2 h-2 rounded-full bg-sky-600 dark:bg-cyan-500"
                                  />
                                </motion.div>
                              </button>
                              <span className={`text-xs font-bold transition-colors ${!isSuspended ? 'text-sky-600 dark:text-cyan-400' : 'text-gray-400'}`}>
                          ...
                          <td className="p-4 whitespace-nowrap">
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                title="عرض التفاصيل"
                                className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors border ${selectedStudentDetails?.id === student.id ? 'bg-sky-600 dark:bg-cyan-500 text-white border-transparent' : 'bg-white dark:bg-[#1C1C28] text-sky-600 dark:text-cyan-400 border-gray-200 dark:border-[#3D3D4D] hover:bg-blue-50 dark:hover:bg-blue-900/20'}`}
                              >
          ...
          {selectedStudentDetails && (
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
              ...
              <motion.div
                ...
                className="bg-white dark:bg-[#111827] rounded-[32px] w-full max-w-xl relative z-10 shadow-2xl border border-gray-100 dark:border-slate-800 overflow-hidden"
              >
                <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between shrink-0 bg-gray-50/50 dark:bg-[#222230]/50">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-sky-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 flex items-center justify-center font-black text-white text-xl shadow-md">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-1">
                        ...
                        {selectedStudentDetails.educationSystem === 'baccalaureate' && (
                          <span className="text-xs font-black bg-amber-50 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400 px-2 py-0.5 rounded-lg border border-amber-100 dark:border-amber-800/30">
                            بكالوريا
                          </span>
                        )}
                      </div>
                ...
                <div className="p-6 space-y-6">
                  <div>
                    <h5 className="text-gray-900 dark:text-white font-black mb-4 flex items-center gap-2 text-sm">
                      <span className="w-1.5 h-5 bg-sky-600 dark:bg-cyan-500 rounded-full"></span>
                      معلومات التواصل
                    </h5>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="flex items-center gap-3 bg-gray-50 dark:bg-[#222230] p-3 rounded-xl border border-gray-100 dark:border-[#3D3D4D]">
                        <div className="w-8 h-8 rounded-lg bg-white dark:bg-[#111827] flex items-center justify-center shadow-sm shrink-0">
                          <Phone className="w-4 h-4 text-sky-600 dark:text-cyan-400" />
                        </div>
    ...
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
        ...
        <button
          ...
          className="bg-sky-600 dark:bg-cyan-500 text-white px-6 py-3 rounded-2xl font-bold shadow-lg shadow-sky-500/20 dark:shadow-cyan-500/20 hover:bg-[#0077B6] dark:bg-[#B8860B] hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center gap-2"
        >
      ...
      <div className="mb-6 relative max-w-md">
        <input
          ...
          className="w-full bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-2xl pl-4 pr-12 py-3 text-sm focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 focus:ring-1 focus:ring-sky-500 dark:focus:ring-cyan-400 transition-all text-gray-900 dark:text-white placeholder-gray-400"
        />
      ...
      {loading ? (
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#111827] rounded-3xl p-12 text-center border border-gray-100 dark:border-slate-800 shadow-sm"
        >
          <div className="w-24 h-24 bg-sky-500/10 dark:bg-cyan-400/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <BookOpen className="w-12 h-12 text-sky-600 dark:text-cyan-400" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCourses.map((course, index) => (
            <motion.div
              ...
              className={`bg-white dark:bg-[#111827] rounded-3xl overflow-hidden shadow-sm hover:shadow-xl border border-gray-150 dark:border-slate-800 group transition-all duration-300 flex flex-col relative h-full hover:-translate-y-1 ${course.isActive === false ? 'opacity-70 grayscale-[30%]' : ''}`}
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between pointer-events-none">
                <div>
                  {/* Title */}
                  <h3 className="text-lg font-black text-gray-950 dark:text-white mb-2 group-hover:text-sky-600 dark:group-hover:text-cyan-400 transition-colors line-clamp-1">
                    {course.title}
                  </h3>
                ...
                <div>
                  {/* Meta Details */}
                  <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 font-bold mb-4 pt-3 border-t border-gray-100 dark:border-slate-800">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-slate-800 relative z-10 pointer-events-auto">
                    ...
                    <div className="flex gap-1.5">
                      <button 
                        ...
                        className="w-8 h-8 rounded-lg bg-gray-50 dark:bg-[#222230] flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-cyan-400 transition-all"
                      >
        ...
        {showCreateModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-2xl relative z-10 shadow-2xl overflow-hidden flex flex-col max-h-[85vh]"
            >
                  ...
                  <div>
                    ...
                    <div 
                      ...
                      className={`w-full h-48 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center cursor-pointer transition-colors overflow-hidden ${
                        imagePreview 
                          ? 'border-transparent' 
                          : 'border-gray-300 dark:border-slate-800 hover:border-sky-500 dark:hover:border-cyan-500 hover:bg-gray-50 dark:hover:bg-[#222230]'
                      }`}
                    >
                      {imagePreview ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 focus:ring-1 focus:ring-sky-500 dark:focus:ring-cyan-400 transition-all text-gray-900 dark:text-white"
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 focus:ring-1 focus:ring-sky-500 dark:focus:ring-cyan-400 transition-all text-gray-900 dark:text-white resize-none"
              ...
              <div className="p-6 border-t border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-[#090D16] flex justify-end gap-3 sticky bottom-0">
                <button
                  type="button"
                  onClick={() => !isSubmitting && resetForm()}
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="bg-sky-600 dark:bg-cyan-500 text-white px-8 py-3 rounded-xl font-bold shadow-lg shadow-sky-500/20 dark:shadow-cyan-500/20 hover:bg-[#0077B6] dark:bg-[#B8860B] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {isSubmitting ? (
