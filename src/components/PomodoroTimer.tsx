  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col items-center justify-center relative overflow-hidden">
          ...
          {/* Custom adjustments */}
          <div className="mt-8 border-t border-gray-100 dark:border-slate-800 pt-6 w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1 bg-gray-50 dark:bg-[#090D16] p-1.5 rounded-xl border border-gray-100 dark:border-slate-800">
                  <button
        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          {/* Preset templates */}
          <div className="bg-white dark:bg-[#111827] rounded-3xl p-5 border border-gray-200 dark:border-slate-800 shadow-sm">
          ...
          {/* Focus Statistics */}
          <div className="bg-white dark:bg-[#111827] rounded-3xl p-5 border border-gray-200 dark:border-slate-800 shadow-sm space-y-4">
      ...
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm">
        ...
        {loadingSessions ? (
          ...
          <div className="text-center py-8 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-[#090D16] rounded-2xl border border-dashed border-gray-200 dark:border-slate-800">
          ...
          <div className="space-y-2.5 max-h-[300px] overflow-y-auto pr-1">
            {sessions.map((session) => (
              <div 
                key={session.id}
                className="p-3.5 rounded-xl bg-gray-50 dark:bg-[#090D16] hover:bg-gray-100/50 dark:hover:bg-[#15151F] border border-gray-100 dark:border-slate-800/50 flex justify-between items-center transition-all group"
              >
