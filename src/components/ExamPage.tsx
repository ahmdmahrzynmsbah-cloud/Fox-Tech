...
export default function ExamPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#09090E] text-gray-900 dark:text-white flex flex-col" dir="rtl">
      {/* Top Header */}
      <header className="bg-white dark:bg-[#0D121F] border-b border-gray-100 dark:border-[#1E1E2F] py-4 px-6 flex items-center justify-between sticky top-0 z-40">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-sky-500/10 dark:bg-cyan-400/10 flex items-center justify-center text-sky-600 dark:text-cyan-400">
        ...
        <AnimatePresence mode="wait">
          ...
          {showResults && submissionResult ? (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className="w-full bg-white dark:bg-[#0D121F] rounded-3xl p-6 md:p-10 shadow-xl border border-gray-100 dark:border-[#1E1E2F] text-center space-y-8"
            >
              <div className="max-w-md mx-auto space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 bg-gray-50 dark:bg-[#1A1A26] p-5 rounded-2xl border border-gray-100 dark:border-[#222235]">
                  <div className="text-center space-y-0.5">
                    ...
                    <p className="text-lg font-black text-sky-600 dark:text-cyan-400">
              ...
              <div className="text-right space-y-6 pt-6 border-t border-gray-100 dark:border-[#1E1E2F]">
                <h4 className="text-base font-black text-gray-900 dark:text-white flex items-center gap-2">
                  <BookOpenCheck className="w-5 h-5 text-sky-600 dark:text-cyan-400" />
            ...
            <motion.div
              ...
              className="w-full bg-white dark:bg-[#0D121F] rounded-3xl p-6 md:p-10 shadow-xl border border-gray-100 dark:border-[#1E1E2F] space-y-8 text-right"
            >
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-gray-50 dark:bg-[#1A1A26] rounded-2xl border border-gray-100 dark:border-[#1E1E2F] flex items-center gap-3">
                    <Clock className="w-6 h-6 text-sky-600 dark:text-cyan-400" />
                    <div>
            ...
            >
              ...
              <div className="w-full lg:w-1/4 bg-white dark:bg-[#0D121F] rounded-3xl p-5 shadow-lg border border-gray-100 dark:border-[#1E1E2F] space-y-4 shrink-0">
                ...
                <div className="grid grid-cols-5 lg:grid-cols-4 gap-2">
                  {questionsList.map((q, idx) => {
                    ...
                    if (isAnswered) {
                      bgStyle = "bg-[#00B4D8]/10 text-sky-600 border border-sky-500/30 dark:bg-[#D4AF37]/10 dark:text-cyan-400 dark:border-cyan-500/30";
                    }
                    if (isActive) {
                      bgStyle = "bg-gradient-to-l from-[#00B4D8] to-[#0077B6] dark:from-[#D4AF37] dark:to-[#AA7C11] text-white shadow-md shadow-sky-500/10";
                    }
              ...
              <div className="w-full lg:w-3/4 flex flex-col gap-5">
                ...
                <div className="bg-white dark:bg-[#0D121F] rounded-2xl p-4 shadow-md border border-gray-100 dark:border-[#1E1E2F] flex flex-col sm:flex-row gap-3 items-center justify-between">
                        ...
                        return (
                          <button
                            ...
                            className={`p-4 rounded-2xl border text-right text-xs font-bold transition-all flex items-center justify-between ${
                              isSelected
                                ? "bg-gradient-to-l from-[#00B4D8]/10 to-[#0077B6]/5 border-sky-500 text-sky-700 dark:from-[#D4AF37]/10 dark:to-[#AA7C11]/5 dark:border-cyan-500 dark:text-cyan-400 shadow-sm shadow-sky-500/5"
                          ...
                          >
                            ...
                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ml-3 ${
                              isSelected
                                ? "border-sky-500 dark:border-cyan-400 bg-sky-600 dark:bg-cyan-500"
                  ...
                  <div className="flex items-center justify-between gap-4 pt-8 border-t border-gray-100 dark:border-[#1E1E2F] mt-8">
                    ...
                    {currentIdx < questionsList.length - 1 ? (
                      <button
                        ...
                        className="px-5 py-3 rounded-2xl bg-sky-600 dark:bg-cyan-500 text-white hover:bg-[#0077B6] dark:hover:bg-[#b08e2a] font-black text-xs transition-colors flex items-center gap-1.5"
                      >
                        التالي
        ...
        {showExitModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white dark:bg-[#0D121F] rounded-3xl p-6 max-w-md w-full shadow-2xl border border-gray-100 dark:border-[#1E1E2F] space-y-6 text-right"
            >
        ...
        {showInfractionWarning && infractions < 3 && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 15 }}
              className="relative bg-white dark:bg-[#0D121F] rounded-3xl p-6 max-w-md w-full shadow-2xl border border-red-500/30 space-y-6 text-center"
            >
