...
import { 
  ...
  CreditCard, Image as ImageIcon, XCircle, Copy, History, DollarSign, Ticket, Wallet, RefreshCw, Film, PlayCircle, Heart, HelpCircle, Target,
...
const WalletRecharge = ({ users, setUsers, payments }: { users: any[], setUsers: React.Dispatch<React.SetStateAction<any[]>>, payments: any[] }) => {
  ...
  const handleGenerateCode = async () => {
    ...
    try {
      ...
      const code = `FOX-${chargeAmt}-${randomSuffix}`;
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-300" dir="rtl">
      {/* Sub-Tabs Selector */}
      <div className="flex gap-6 border-b border-gray-100 dark:border-slate-800 pb-3.5">
        <button
        ...
        >
          ...
          {walletSubTab === 'charge' && (
            <motion.div 
              ...
              className="absolute -bottom-[15px] left-0 right-0 h-[3px] bg-sky-600 dark:bg-cyan-500 rounded-t-full shadow-sm" 
            />
          )}
        </button>
      ...
      {walletSubTab === 'charge' ? (
        <div className="space-y-8 animate-in fade-in duration-300">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="lg:col-span-1 bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm space-y-4">
              <h3 className="text-lg font-black text-gray-900 dark:text-white flex items-center gap-2">
                <Users className="w-5 h-5 text-sky-600 dark:text-cyan-400" /> البحث عن طالب
              </h3>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl pr-9 pl-4 py-3 outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 text-sm font-bold text-gray-900 dark:text-white"
                />
              </div>
                    ...
                    <button
                      ...
                      className={`w-full text-right p-3 rounded-2xl border text-sm font-bold flex items-center justify-between transition-all ${
                        selectedStudent?.id === student.id
                          ? 'border-sky-500 dark:border-cyan-400 bg-sky-500/5 dark:bg-cyan-400/5 text-sky-600 dark:text-cyan-400'
                          : 'border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-[#15151F] text-gray-700 dark:text-gray-300'
                      }`}
                    >
            ...
            <div className="lg:col-span-2 space-y-6">
              {selectedStudent ? (
                <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm space-y-6">
                  {/* Student Header Info */}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-gray-50 dark:bg-[#090D16]/50 border border-gray-100 dark:border-slate-800 rounded-2xl p-4 flex items-center gap-4">
                  ...
                  <div className="space-y-4">
                      ...
                      {['50', '100', '150', '200', '300', '500'].map(val => (
                        <button
                          ...
                          className={`py-2 px-3 text-xs font-black rounded-xl border transition-all cursor-pointer ${
                            amount === val
                              ? 'border-sky-500 dark:border-cyan-400 bg-sky-500/10 dark:bg-cyan-400/10 text-sky-600 dark:text-cyan-400'
                              : 'border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-[#15151F] text-gray-600 dark:text-gray-400'
                          }`}
                        >
                          {val} ج.م
                        </button>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl px-4 py-3 outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 text-sm font-bold text-gray-900 dark:text-white font-mono"
                      />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3.5 bg-gradient-to-r from-cyan-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 hover:opacity-90 disabled:opacity-50 text-white rounded-2xl font-black text-sm transition-all shadow-md active:scale-95 duration-200 cursor-pointer border-0"
                    >
                      {loading ? (
                    ...
                    {generatedCode && (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                          <div className="bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-2xl px-6 py-3 font-mono text-lg font-black text-gray-900 dark:text-white select-all">
                            {generatedCode}
                          </div>
                          <button
                            type="button"
                ...
                <div className="bg-white dark:bg-[#111827] p-8 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm text-center space-y-4 py-16">
          ...
          <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm space-y-6">
            ...
            {loadingCodes ? (
              <div className="flex justify-center items-center py-12">
                <Loader2 className="w-6 h-6 text-sky-600 dark:text-cyan-400 animate-spin" />
              </div>
            ) : rechargeCodes.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="w-full text-right border-collapse text-xs md:text-sm">
                  <thead>
                    <tr className="border-b border-gray-100 dark:border-slate-800 text-gray-400 font-black">
                  ...
                  <tbody className="divide-y divide-gray-50 dark:divide-[#2D2D3D]/50 font-bold">
                    {rechargeCodes.map(codeDoc => (
                      <tr key={codeDoc.code} className="hover:bg-gray-50/50 dark:hover:bg-[#15151F]/40 transition-colors">
                        <td className="py-4 font-mono font-black text-sky-600 dark:text-cyan-400">{codeDoc.code}</td>
        ...
        <div className="space-y-6 animate-in fade-in duration-300">
          {/* Header Controls */}
          <div className="bg-white dark:bg-[#111827] p-5 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-black cursor-pointer border-0 transition-all ${
                    requestsStatusFilter === status
                      ...
                      : 'bg-gray-50 text-gray-500 hover:bg-gray-100 dark:bg-[#0D121F] dark:text-gray-400 dark:hover:bg-gray-800'
                  }`}
                >
                  {status === 'all' && 'الكل'}
            ...
            <div className="relative w-full md:w-72">
              ...
              <input
                ...
                className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl pr-9 pl-4 py-2.5 outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 text-xs font-bold text-gray-900 dark:text-white"
              />
            </div>
          </div>
          ...
          {loadingRequests ? (
            <div className="py-20 flex flex-col items-center justify-center gap-2">
              <Loader2 className="w-8 h-8 text-sky-600 dark:text-cyan-400 animate-spin" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredRequests.map(req => (
                <div 
                  key={req.id}
                  className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col justify-between gap-5 hover:shadow-md transition-all relative overflow-hidden"
                >
                  <div className="flex justify-between items-start gap-4">
                    <div className="space-y-3 text-right">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="text-2xl font-black text-sky-600 dark:text-cyan-400 font-mono">
                      ...
                      {req.status !== 'pending' && (
                        <div className="p-3 rounded-2xl bg-gray-50 dark:bg-[#0D121F] border border-gray-100 dark:border-slate-800/50 text-[10px] leading-relaxed text-gray-500 space-y-1">
                  ...
                  {req.status === 'pending' && (
                    <div className="grid grid-cols-2 gap-3 pt-2 border-t border-gray-50 dark:border-slate-800/50">
                      <button
            ...
            <div className="p-12 text-center bg-white dark:bg-[#111827] rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm font-bold text-gray-400">
        ...
        {codeToDelete && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-white dark:bg-[#111827] max-w-md w-full rounded-3xl p-6 shadow-2xl border border-gray-100 dark:border-slate-800 text-right space-y-4"
              dir="rtl"
            >
        ...
        {selectedReceipt && (
          ...
          >
            <motion.div 
              ...
              className="relative max-w-lg w-full bg-white dark:bg-[#0D121F] rounded-3xl overflow-hidden p-2 shadow-2xl"
            >
              <button 
                onClick={() => setSelectedReceipt(null)}
            ...
            >
              ...
              <form onSubmit={handleRejectTransfer} className="space-y-4">
                <textarea
                  ...
                  className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl px-4 py-3 outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 text-xs font-bold text-gray-900 dark:text-white h-24 resize-none"
                />
...
export default function AdminPanel({ initialTab, userData }: { initialTab?: 'students' | 'teachers' | 'parents' | 'approvals' | 'special_approvals' | 'payments' | 'settings' | 'wallet' | 'courses' | 'subscription_requests' | 'support_requests' | 'admin_codes'; userData?: any }) {
  ...
  const [tempStatsCounters, setTempStatsCounters] = useState<StatCounterItem[]>(
    platformSettings.statsCounters && platformSettings.statsCounters.length > 0
      ...
      : [
          ...
          { id: '2', value: 92, suffix: '%', label: 'نسبة رضا الطلاب' },
          { id: '3', value: 120, suffix: '+', label: 'دورة تدريبية' },
          { id: '4', value: 4.1, suffix: '', label: 'تقييم المنصة' }
        ]
  );
  ...
  useEffect(() => {
    if (platformSettings.statsCounters && platformSettings.statsCounters.length > 0) {
      setTempStatsCounters(platformSettings.statsCounters.map(stat => {
        if (
  ...
  // Hero Content Items State & Handlers
  const defaultHeroContentItems = [
    'مقدمة في تكنولوجيا المعلومات والمجتمع',
    'كيف يعمل الذكاء الاصطناعي (AI Mechanics)',
    'الذكاء الاصطناعي في الحياة اليومية والصناعية',
    'الأمن السيبراني وتصميم أمن الشبكات',
    'تطبيقات الويب والبنية العامة لتطبيقات الويب',
    'تصميم الويب والوسائط المتعددة التفاعلية'
  ];

  const [tempHeroContentItems, setTempHeroContentItems] = useState<string[]>(
    platformSettings.heroContentItems && platformSettings.heroContentItems.length > 0
      ? platformSettings.heroContentItems
      : defaultHeroContentItems
  );
  const [newHeroContentItem, setNewHeroContentItem] = useState('');
  const [isAddingHeroItem, setIsAddingHeroItem] = useState(false);
  const [editingHeroItemIndex, setEditingHeroItemIndex] = useState<number | null>(null);
  const [editingHeroItemValue, setEditingHeroItemValue] = useState('');

  useEffect(() => {
    if (platformSettings.heroContentItems && platformSettings.heroContentItems.length > 0) {
      setTempHeroContentItems(platformSettings.heroContentItems);
    }
  }, [platformSettings.heroContentItems]);

  const handleAddHeroItem = () => {
    if (!newHeroContentItem.trim()) {
      toast.error('يرجى كتابة عنوان عنصر المحتوى أولاً');
      return;
    }
    setTempHeroContentItems(prev => [...prev, newHeroContentItem.trim()]);
    setNewHeroContentItem('');
    setIsAddingHeroItem(false);
    toast.success('تمت إضافة العنصر لقائمة المحتوى بنجاح! لا تنسَ حفظ الإعدادات');
  };

  const handleDeleteHeroItem = (index: number) => {
    setTempHeroContentItems(prev => prev.filter((_, i) => i !== index));
    toast.success('تم حذف العنصر من القائمة');
  };

  const handleStartEditHeroItem = (index: number, val: string) => {
    setEditingHeroItemIndex(index);
    setEditingHeroItemValue(val);
  };

  const handleSaveEditHeroItem = (index: number) => {
    if (!editingHeroItemValue.trim()) {
      toast.error('لا يمكن ترك عنصر المحتوى فارغاً');
      return;
    }
    setTempHeroContentItems(prev => prev.map((item, i) => i === index ? editingHeroItemValue.trim() : item));
    setEditingHeroItemIndex(null);
    setEditingHeroItemValue('');
    toast.success('تم تعديل العنصر بنجاح');
  };

  const handleMoveHeroItem = (index: number, direction: 'up' | 'down') => {
    setTempHeroContentItems(prev => {
      const copy = [...prev];
  ...
  const handleResetHeroItems = () => {
    setTempHeroContentItems(defaultHeroContentItems);
    toast.success('تمت استعادة قائمة المحتوى الافتراضية');
  };
  ...
  const showSuccessToast = (message: string, type: 'edit' | 'delete', userName?: string) => {
    toast.custom((t) => (
      <div
        ...
        } max-w-md w-full bg-white dark:bg-[#111827] shadow-2xl rounded-2xl pointer-events-auto flex ring-1 ring-black/5 dark:ring-white/10 border-r-4 ${
...
const handleSaveSettings = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const updated: any = {
        platformName: (formData.get('platformName') as string) || platformSettings.platformName || 'Fox Tech',
        logoChar: (formData.get('logoChar') as string) || platformSettings.logoChar || 'F',
        logoUrl: logoUrl || '',
        ...
        heroAudienceTitle: (formData.get('heroAudienceTitle') as string) || platformSettings.heroAudienceTitle || 'للمطورين والمهندسين',
        heroLaunchTitle: (formData.get('heroLaunchTitle') as string) || platformSettings.heroLaunchTitle || 'البداية 30 اغسطس 2026',
        heroLaunchTime: (formData.get('heroLaunchTime') as string) || platformSettings.heroLaunchTime || 'يوم الأحد 6 مساءً',
        heroCurriculumNote: formData.get('heroCurriculumNote') !== null ? (formData.get('heroCurriculumNote') as string) : (platformSettings.heroCurriculumNote || 'شامل المسارات البرمجية المعتمدة + تطبيقات عملية ومشاريع ذكاء اصطناعي'),
        heroContentTitle: (formData.get('heroContentTitle') as string) || platformSettings.heroContentTitle || 'المحتوى',
        heroContentBadge: (formData.get('heroContentBadge') as string) || platformSettings.heroContentBadge || 'Fox Tech 2026',
        heroContentItems: tempHeroContentItems || [],
        heroDateDay: (formData.get('heroDateDay') as string) || platformSettings.heroDateDay || '30',
        heroDateMonthYear: (formData.get('heroDateMonthYear') as string) || platformSettings.heroDateMonthYear || 'AUG 2026',
        heroDateTime: (formData.get('heroDateTime') as string) || platformSettings.heroDateTime || 'يوم الأحد 6 مساءً',
        heroDateTag: (formData.get('heroDateTag') as string) || platformSettings.heroDateTag || 'شامل الشرح والتطبيق',
        ...
        enableQuduratTahsili: formData.get('enableQuduratTahsili') === 'true',
        showQuduratSection: formData.get('showQuduratSection') === 'true',
        showTahsiliSection: formData.get('showTahsiliSection') === 'true',
        ...
        fontFamily: (formData.get('fontFamily') as string) || platformSettings.fontFamily || 'Tajawal',
        socialLinks: {
  ...
  if (activeTab === 'wallet') {
    return (
      <div className="space-y-6 print:hidden animate-in fade-in duration-300" dir="rtl">
        {/* Upper Panel Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm">
          <div>
            <h2 className="text-2xl font-black text-gray-900 dark:text-white flex items-center gap-2">
              <Ticket className="w-6 h-6 text-sky-600 dark:text-cyan-400" />
              شحن رصيد الطلاب وتوليد الكروت
            </h2>
            <p className="text-gray-500 dark:text-gray-400 font-bold text-sm mt-1">البحث عن المتدرب المطلوب، شحن محفظته مباشرة، وتوليد كروت الشحن لمنصة {platformSettings.platformName || 'Fox Tech'}</p>
          </div>
  ...
  return (
    <div className="space-y-6 print:hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="flex items-center gap-2 bg-sky-500/10 dark:bg-cyan-400/10 px-4 py-2 rounded-2xl border border-sky-500/20 dark:border-cyan-400/20">
          <Activity className="w-4 h-4 text-sky-600 dark:text-cyan-400" />
          <span className="text-xs font-black text-sky-600 dark:text-cyan-400">النظام نشط ومحمي</span>
        </div>
      </div>

      {/* Summary Statistics Mini Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-[#111827] p-5 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-900/20 text-sky-600 flex items-center justify-center shrink-0">
      ...
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm">
        <div className="flex flex-wrap gap-4 border-b border-gray-100 dark:border-slate-800 pb-3 mb-6">
          <button
          ...
          >
            ...
            {activeTab === 'students' && (
              <motion.div 
                layoutId="adminTab" 
                className="absolute -bottom-[13px] left-0 right-0 h-[3px] bg-sky-600 dark:bg-cyan-500 rounded-t-full shadow-[0_1px_4px_rgba(0,180,216,0.3)] dark:shadow-[0_1px_4px_rgba(212,175,55,0.3)]" 
        ...
        {activeTab === 'students' && (
          <div className="flex gap-2 mb-5 bg-gray-50/50 dark:bg-[#0D121F]/30 p-1 rounded-xl border border-gray-150 dark:border-slate-800 w-full max-w-xs animate-in fade-in duration-200">
            <button
              ...
              className={`flex-1 py-1.5 px-3 rounded-lg text-xs font-black transition-all flex items-center justify-center gap-1.5 ${
                studentStatusFilter === 'active'
                  ? 'bg-sky-600 dark:bg-cyan-500 text-white dark:text-[#0D0D12] shadow-sm'
                  : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'
              }`}
            >
              <CheckCircle2 className="w-3.5 h-3.5" />
        ...
        {activeTab !== 'settings' && activeTab !== 'courses' && (
          <div className="bg-gray-50/50 dark:bg-[#090D16]/30 p-4 rounded-2xl border border-gray-150 dark:border-slate-800 mb-6 flex flex-col gap-4 animate-in fade-in duration-200">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
              ...
              <div className="relative md:col-span-5">
                ...
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl pr-10 pl-4 py-2.5 text-sm font-bold text-gray-900 dark:text-white outline-none focus:border-sky-500 dark:focus:border-cyan-500 focus:ring-1 focus:ring-sky-500 dark:focus:ring-cyan-400 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600"
                />
                {searchQuery && (
                  <button
              ...
              {(activeTab === 'students' || activeTab === 'teachers' || activeTab === 'approvals') ? (
                ...
                >
                  <option value="all">كل الصفوف والمسارات</option>
                  <option value="الأول الثانوي">المستوى الأول (مبتدئ)</option>
                  <option value="الثاني الثانوي">المستوى الثاني (متوسط)</option>
                  <option value="الثالث الثانوي">المستوى الثالث (متقدم)</option>
                </select>
              </div>
            ) : (
          ...
          {(searchQuery || gradeFilter !== 'all' || subjectFilter !== 'all' || sortBy !== 'name_asc') && (
            <div className="flex flex-wrap items-center justify-between gap-2 border-t border-gray-100 dark:border-slate-800 pt-3 text-xs font-bold text-gray-500 dark:text-gray-400">
              <div className="flex flex-wrap items-center gap-2">
                <span>الفلاتر النشطة:</span>
                {searchQuery && (
                  <span className="bg-[#00B4D8]/10 text-sky-600 dark:text-sky-600 dark:bg-[#00B4D8]/5 px-2.5 py-1 rounded-lg border border-sky-500/20 flex items-center gap-1">
                    البحث: "{searchQuery}"
        ...
        {loading || loadingSettings ? (
          ...
          <form onSubmit={handleSaveSettings} className="space-y-6 max-w-4xl mx-auto py-4 animate-in fade-in duration-300">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50/50 dark:bg-[#090D16]/30 p-6 rounded-2xl border border-gray-150 dark:border-slate-800 md:col-span-2 space-y-4">
                <h3 className="text-base font-black text-gray-800 dark:text-white flex items-center gap-2">
                  <Shield className="w-5 h-5 text-sky-600 dark:text-cyan-400" /> هوية المنصة الأساسية
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2.5 outline-none focus:border-sky-500 dark:focus:border-cyan-500 dark:text-white font-bold text-sm"
                      required
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      {(logoFile || platformSettings.logoUrl) ? (
                        <div className="w-12 h-12 rounded-xl overflow-hidden bg-gray-100 dark:bg-slate-800 flex items-center justify-center shrink-0 border border-gray-200 dark:border-slate-800 p-1">
                          <img 
                        ...
                        <div className="h-10 px-3 rounded-xl bg-gray-100 dark:bg-slate-800/80 flex items-center justify-center shrink-0 border border-gray-200 dark:border-slate-800">
                          <FoxTechLogo className="h-7 w-auto max-w-[120px]" variant="auto" />
                        </div>
                      )}
                      <input
                        type="file"
                        ...
                        className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-sky-500 dark:focus:border-cyan-500 dark:text-gray-300 text-xs file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-bold file:bg-[#00B4D8]/10 file:text-sky-600 hover:file:bg-[#00B4D8]/20 cursor-pointer"
                      />
                    </div>
                  </div>
                </div>
                ...
                {/* Font Selector */}
                <div className="pt-4 border-t border-gray-200 dark:border-slate-800/80">
                  <label className="text-xs font-bold text-gray-500 block mb-2">نوع الخط العربي للمنصة (Typography)</label>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                    {[
                      { id: 'Alan Sans', name: 'ألان سانس (Alan Sans)', desc: 'الخط الأساسي للمنصة (IBM Plex + Alan)' },
                      { id: 'IBM Plex Sans Arabic', name: 'آي بي إم بلكس (IBM Plex)', desc: 'احترافي ومريح للعين' },
                      { id: 'Tajawal', name: 'تجوال (Tajawal)', desc: 'خط حديث خفيف ورشيق' },
                      { id: 'Cairo', name: 'كايرو (Cairo)', desc: 'عريض وبارز' },
                    ].map(f => {
                      const isSelected = (platformSettings.fontFamily || 'Alan Sans') === f.id;
                      return (
                        <label
                          key={f.id}
                          className={`relative flex flex-col p-3 rounded-2xl border-2 cursor-pointer transition-all ${
                            isSelected
                              ? 'border-[#D4F800] bg-[#D4F800]/10 text-slate-900 dark:text-white shadow-sm'
                              : 'border-gray-200 dark:border-slate-800 bg-white dark:bg-[#0D121F] text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:hover:border-slate-700'
                          }`}
                        >
                          <input
                            type="radio"
                          ...
                          <div className="flex items-center justify-between mb-1">
                            ...
                            {isSelected && <span className="w-2 h-2 rounded-full bg-[#D4F800]"></span>}
                          </div>
              ...
              {/* Visibility Settings Card - Full Width Under Identity */}
              <div className="bg-gray-50/60 dark:bg-[#090D16]/40 p-5 sm:p-7 rounded-3xl border border-gray-200 dark:border-slate-800 md:col-span-2 space-y-6 shadow-xs">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-200 dark:border-slate-800 pb-5">
                  <div className="space-y-1">
                    <h3 className="text-base sm:text-lg font-black text-gray-900 dark:text-white flex items-center gap-2.5">
                      ...
                      إدارة وتفعيل أقسام المنصة ومسارات القدرات والتحصيلي
                    </h3>
                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                      مفاتيح تحكم ذكية بمزامنة لحظية مباشرة — أي تغيير يطبّق فوراً للطلاب والزوار دون الحاجة لإعادة تحميل الصفحة.
                    </p>
                  </div>
                  <div className="flex items-center gap-2 shrink-0">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-full text-xs font-black border border-emerald-200 dark:border-emerald-500/20 shadow-xs">
                ...
                {/* Master Switch for Qudurat and Tahsili */}
                <div className={`p-5 sm:p-6 rounded-2xl border transition-all duration-300 ${
                  platformSettings.enableQuduratTahsili !== false
                    ? 'border-amber-400/60 dark:border-amber-500/40 bg-amber-50/50 dark:bg-amber-950/15 shadow-sm'
                    : 'border-gray-200 dark:border-slate-800 bg-gray-100/60 dark:bg-slate-900/40'
                }`}>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 font-medium leading-relaxed max-w-3xl">
                          سويتش رئيسي شامل: عند إيقافه يتم إخفاء كل ما يخص القدرات والتحصيلي من الواجهة الرئيسية والقوائم الجانبية للطلاب وصفحة التسجيل دفعة واحدة.
                        </p>
                      </div>
                    </div>

                    {/* Master Switch Button */}
                    <div className="flex items-center gap-3.5 self-end md:self-center shrink-0 bg-white/80 dark:bg-slate-900/80 px-4 py-2 rounded-2xl border border-gray-200/80 dark:border-slate-800 shadow-xs">
                      <span className="text-xs font-black text-gray-700 dark:text-gray-200">
                        {platformSettings.enableQuduratTahsili !== false ? 'مفعل' : 'معطل'}
                      </span>
                      <button
                        type="button"
                        role="switch"
                        aria-checked={platformSettings.enableQuduratTahsili !== false}
                        onClick={async () => {
                          const currentVal = platformSettings.enableQuduratTahsili !== false;
                          const newVal = !currentVal;
                          try {
                            await updateSettings({
                              ...platformSettings,
                              enableQuduratTahsili: newVal,
                        ...
                        dir="ltr"
                        className={`relative inline-flex h-7 w-13 shrink-0 cursor-pointer rounded-full p-0.5 transition-colors duration-200 ease-in-out focus:outline-none shadow-inner items-center ${
                          platformSettings.enableQuduratTahsili !== false
                            ? 'bg-amber-500'
                      ...
                      >
                        <span
                          className={`pointer-events-none flex items-center justify-center h-6 w-6 transform rounded-full bg-white shadow-md transition-transform duration-200 ease-in-out ${
                            platformSettings.enableQuduratTahsili !== false ? 'translate-x-6' : 'translate-x-0'
                          }`}
                        >
                          {platformSettings.enableQuduratTahsili !== false ? (
                  ...
                  <input
                    type="hidden"
                    name="enableQuduratTahsili"
                    value={platformSettings.enableQuduratTahsili !== false ? 'true' : 'false'}
                  />
                </div>

                {/* Sub-Section Switches Grid */}
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="text-xs font-black text-gray-500 uppercase tracking-wider">
                      إدارة تفعيل الأقسام بشكل منفصل
                    </h4>
                    <span className="text-[11px] text-gray-400 font-medium">6 أقسام تحكم</span>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4.5">
                    {/* Qudurat Switch */}
                    <div className={`p-4.5 sm:p-5 rounded-2xl border transition-all duration-200 flex flex-col justify-between gap-3 ${
                      platformSettings.showQuduratSection !== false && platformSettings.enableQuduratTahsili !== false
                        ? 'bg-white dark:bg-[#0D121F] border-emerald-500/40 shadow-xs'
                        : 'bg-gray-100/70 dark:bg-[#090D16]/60 border-gray-200 dark:border-slate-800 opacity-80'
                    }`}>
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span className={`text-[11px] font-black px-2 py-0.5 rounded-md ${
                            ...
                            {platformSettings.showQuduratSection !== false && platformSettings.enableQuduratTahsili !== false ? 'مفعل' : 'معطل'}
                          </span>
                          <button
                            type="button"
                            role="switch"
                            disabled={platformSettings.enableQuduratTahsili === false}
                            aria-checked={platformSettings.showQuduratSection !== false}
                            onClick={async () => {
                              const currentVal = platformSettings.showQuduratSection !== false;
                              const newVal = !currentVal;
                              try {
                                await updateSettings({
                                  ...platformSettings,
                            ...
                            dir="ltr"
                            className={`relative inline-flex h-6.5 w-12 shrink-0 cursor-pointer rounded-full p-0.5 transition-colors duration-200 ease-in-out items-center ${
                              platformSettings.showQuduratSection !== false && platformSettings.enableQuduratTahsili !== false
                                ? 'bg-emerald-500'
                                : 'bg-gray-300 dark:bg-slate-700'
                            } ${platformSettings.enableQuduratTahsili === false ? 'opacity-40 cursor-not-allowed' : ''}`}
                          >
                            <span
                              className={`pointer-events-none flex items-center justify-center h-5.5 w-5.5 transform rounded-full bg-white shadow-sm transition-transform duration-200 ease-in-out ${
                                platformSettings.showQuduratSection !== false && platformSettings.enableQuduratTahsili !== false ? 'translate-x-5.5' : 'translate-x-0'
                              }`}
                            >
                              {platformSettings.showQuduratSection !== false && platformSettings.enableQuduratTahsili !== false ? (
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                        إظهار بنك أسئلة وفيديوهات ومراجعات مسار القدرات للطلاب في المنصة.
                      </p>
                      <input
                        type="hidden"
                        name="showQuduratSection"
                        value={platformSettings.showQuduratSection !== false ? 'true' : 'false'}
                      />
                    </div>

                    {/* Tahsili Switch */}
                    <div className={`p-4.5 sm:p-5 rounded-2xl border transition-all duration-200 flex flex-col justify-between gap-3 ${
                      platformSettings.showTahsiliSection !== false && platformSettings.enableQuduratTahsili !== false
                        ? 'bg-white dark:bg-[#0D121F] border-purple-500/40 shadow-xs'
                        : 'bg-gray-100/70 dark:bg-[#090D16]/60 border-gray-200 dark:border-slate-800 opacity-80'
                    }`}>
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span className={`text-[11px] font-black px-2 py-0.5 rounded-md ${
                            ...
                            {platformSettings.showTahsiliSection !== false && platformSettings.enableQuduratTahsili !== false ? 'مفعل' : 'معطل'}
                          </span>
                          <button
                            type="button"
                            role="switch"
                            disabled={platformSettings.enableQuduratTahsili === false}
                            aria-checked={platformSettings.showTahsiliSection !== false}
                            onClick={async () => {
                              const currentVal = platformSettings.showTahsiliSection !== false;
                              const newVal = !currentVal;
                              try {
                                await updateSettings({
                                  ...platformSettings,
                          ...
                          >
                            <span
                              className={`pointer-events-none flex items-center justify-center h-5.5 w-5.5 transform rounded-full bg-white shadow-sm transition-transform duration-200 ease-in-out ${
                                platformSettings.showTahsiliSection !== false && platformSettings.enableQuduratTahsili !== false ? 'translate-x-5.5' : 'translate-x-0'
                              }`}
                            >
                              {platformSettings.showTahsiliSection !== false && platformSettings.enableQuduratTahsili !== false ? (
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                        إظهار بنك أسئلة وفيديوهات ومراجعات مسار التحصيلي للطلاب في المنصة.
                      </p>
                      <input
                        type="hidden"
                        name="showTahsiliSection"
                        value={platformSettings.showTahsiliSection !== false ? 'true' : 'false'}
                      />
                    </div>

                    {/* Grades Section Switch */}
                    <div className={`p-4.5 sm:p-5 rounded-2xl border transition-all duration-200 flex flex-col justify-between gap-3 ${
                      platformSettings.showGradesSection
                        ? 'bg-white dark:bg-[#0D121F] border-blue-500/40 shadow-xs'
                        : 'bg-gray-100/70 dark:bg-[#090D16]/60 border-gray-200 dark:border-slate-800 opacity-80'
                    }`}>
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span className={`text-[11px] font-black px-2 py-0.5 rounded-md ${
                            ...
                            {platformSettings.showGradesSection ? 'مفعل' : 'معطل'}
                          </span>
                          <button
                            type="button"
                            role="switch"
                            aria-checked={platformSettings.showGradesSection}
                            onClick={async () => {
                              const currentVal = Boolean(platformSettings.showGradesSection);
                              const newVal = !currentVal;
                              try {
                                await updateSettings({
                                  ...platformSettings,
                                  showGradesSection: newVal
                                });
                                toast.success(newVal ? 'تم تفعيل قسم الصفوف الدراسية' : 'تم إخفاء قسم الصفوف الدراسية');
                              } catch (e) {
                                toast.error('حدث خطأ');
                              }
                            }}
                          ...
                          >
                            <span
                              className={`pointer-events-none flex items-center justify-center h-5.5 w-5.5 transform rounded-full bg-white shadow-sm transition-transform duration-200 ease-in-out ${
                                platformSettings.showGradesSection ? 'translate-x-5.5' : 'translate-x-0'
                              }`}
                            >
                              {platformSettings.showGradesSection ? (
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                        عرض بطاقات المراحل الدراسية (الصف الأول الثانوي، الصف الثاني الثانوي - بكالوريا، الصف الثالث الثانوي) بالصفحة الرئيسية.
                      </p>
                      <input
                        type="hidden"
                        name="showGradesSection"
                        value={platformSettings.showGradesSection ? 'true' : 'false'}
                      />
                    </div>

                    {/* Subjects Section Switch */}
                    <div className={`p-4.5 sm:p-5 rounded-2xl border transition-all duration-200 flex flex-col justify-between gap-3 ${
                      platformSettings.showSubjectsSection
                        ? 'bg-white dark:bg-[#0D121F] border-indigo-500/40 shadow-xs'
                        : 'bg-gray-100/70 dark:bg-[#090D16]/60 border-gray-200 dark:border-slate-800 opacity-80'
                    }`}>
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span className={`text-[11px] font-black px-2 py-0.5 rounded-md ${
                            ...
                            {platformSettings.showSubjectsSection ? 'مفعل' : 'معطل'}
                          </span>
                          <button
                            type="button"
                            role="switch"
                            aria-checked={platformSettings.showSubjectsSection}
                            onClick={async () => {
                              const currentVal = Boolean(platformSettings.showSubjectsSection);
                              const newVal = !currentVal;
                              try {
                                await updateSettings({
                                  ...platformSettings,
                                  showSubjectsSection: newVal
                                });
                                toast.success(newVal ? 'تم تفعيل قسم المواد الدراسية' : 'تم إخفاء قسم المواد الدراسية');
                              } catch (e) {
                                toast.error('حدث خطأ');
                              }
                            }}
                          ...
                          >
                            <span
                              className={`pointer-events-none flex items-center justify-center h-5.5 w-5.5 transform rounded-full bg-white shadow-sm transition-transform duration-200 ease-in-out ${
                                platformSettings.showSubjectsSection ? 'translate-x-5.5' : 'translate-x-0'
                              }`}
                            >
                              {platformSettings.showSubjectsSection ? (
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                        عرض شبكة المواد والكورسات المقررة في الصفحة الرئيسية للزوار والطلاب.
                      </p>
                      <input
                        type="hidden"
                        name="showSubjectsSection"
                        value={platformSettings.showSubjectsSection ? 'true' : 'false'}
                      />
                    </div>

                    {/* Features Section Switch */}
                    <div className={`p-4.5 sm:p-5 rounded-2xl border transition-all duration-200 flex flex-col justify-between gap-3 ${
                      platformSettings.showFeaturesSection
                        ? 'bg-white dark:bg-[#0D121F] border-sky-500/40 shadow-xs'
                        : 'bg-gray-100/70 dark:bg-[#090D16]/60 border-gray-200 dark:border-slate-800 opacity-80'
                    }`}>
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span className={`text-[11px] font-black px-2 py-0.5 rounded-md ${
                            ...
                            {platformSettings.showFeaturesSection ? 'مفعل' : 'معطل'}
                          </span>
                          <button
                            type="button"
                            role="switch"
                            aria-checked={platformSettings.showFeaturesSection}
                            onClick={async () => {
                              const currentVal = Boolean(platformSettings.showFeaturesSection);
                              const newVal = !currentVal;
                              try {
                                await updateSettings({
                                  ...platformSettings,
                                  showFeaturesSection: newVal
                                });
                                toast.success(newVal ? 'تم تفعيل قسم مميزات المنصة' : 'تم إخفاء قسم مميزات المنصة');
                              } catch (e) {
                                toast.error('حدث خطأ');
                              }
                            }}
                          ...
                          >
                            <span
                              className={`pointer-events-none flex items-center justify-center h-5.5 w-5.5 transform rounded-full bg-white shadow-sm transition-transform duration-200 ease-in-out ${
                                platformSettings.showFeaturesSection ? 'translate-x-5.5' : 'translate-x-0'
                              }`}
                            >
                              {platformSettings.showFeaturesSection ? (
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                        عرض بطاقات مميزات المنصة الذكية وخطوات رحلة الطالب في الصفحة الرئيسية.
                      </p>
                      <input
                        type="hidden"
                        name="showFeaturesSection"
                        value={platformSettings.showFeaturesSection ? 'true' : 'false'}
                      />
                    </div>

                    {/* FAQ Section Switch */}
                    <div className={`p-4.5 sm:p-5 rounded-2xl border transition-all duration-200 flex flex-col justify-between gap-3 ${
                      platformSettings.showFaqSection
                        ? 'bg-white dark:bg-[#0D121F] border-teal-500/40 shadow-xs'
                        : 'bg-gray-100/70 dark:bg-[#090D16]/60 border-gray-200 dark:border-slate-800 opacity-80'
                    }`}>
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <span className={`text-[11px] font-black px-2 py-0.5 rounded-md ${
                            ...
                            {platformSettings.showFaqSection ? 'مفعل' : 'معطل'}
                          </span>
                          <button
                            type="button"
                            role="switch"
                            aria-checked={platformSettings.showFaqSection}
                            onClick={async () => {
                              const currentVal = Boolean(platformSettings.showFaqSection);
                              const newVal = !currentVal;
                              try {
                                await updateSettings({
                                  ...platformSettings,
                                  showFaqSection: newVal
                                });
                                toast.success(newVal ? 'تم تفعيل قسم الأسئلة الشائعة' : 'تم إخفاء قسم الأسئلة الشائعة');
                              } catch (e) {
                                toast.error('حدث خطأ');
                              }
                            }}
                          ...
                          >
                            <span
                              className={`pointer-events-none flex items-center justify-center h-5.5 w-5.5 transform rounded-full bg-white shadow-sm transition-transform duration-200 ease-in-out ${
                                platformSettings.showFaqSection ? 'translate-x-5.5' : 'translate-x-0'
                              }`}
                            >
                              {platformSettings.showFaqSection ? (
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                        عرض قسم الأسئلة المتكررة والإجابات التوضيحية للزوار والطلاب بالرئيسية.
                      </p>
                      <input
                        type="hidden"
                        name="showFaqSection"
                        value={platformSettings.showFaqSection ? 'true' : 'false'}
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50/50 dark:bg-[#090D16]/30 p-6 rounded-2xl border border-gray-150 dark:border-slate-800 md:col-span-2 space-y-4">
                <h3 className="text-base font-black text-gray-800 dark:text-white flex items-center gap-2">
                  <Film className="w-5 h-5 text-sky-600 dark:text-cyan-400" /> الفيديوهات التعريفية للمسارات (قدرات وتحصيلي)
                </h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-emerald-500 dark:text-white font-bold text-xs cursor-pointer"
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-emerald-500 dark:text-white font-mono text-xs text-left"
                          dir="ltr"
                            ...
                            {(quduratVideoPosterFile || platformSettings.quduratVideoPoster) && (
                              <div className="flex items-center gap-2">
                                <img
                                  ...
                                  className="w-12 h-8 object-cover rounded-md border border-gray-200 dark:border-slate-800"
                                />
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-purple-500 dark:text-white font-bold text-xs cursor-pointer"
                        >
                          <option value="youtube">يوتيوب (YouTube)</option>
                          <option value="tiktok">تيك توك (TikTok)</option>
                          <option value="bunny">باني ستريم (Bunny Stream ID)</option>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-purple-500 dark:text-white font-mono text-xs text-left"
                          dir="ltr"
                          placeholder="https://www.youtube.com/watch?v=... or Video ID"
                        />
                      </div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2.5 outline-none focus:border-sky-500 dark:focus:border-cyan-500 dark:text-white font-bold text-sm leading-relaxed"
                      required
                    />
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs cursor-pointer"
                        >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-mono text-xs text-left"
                          dir="ltr"
                      ...
                      <div className="md:col-span-2 mt-2">
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          <div className="flex items-center gap-3">
                            <label className="cursor-pointer px-3 py-1.5 bg-[#00B4D8]/10 hover:bg-[#00B4D8]/20 text-sky-600 dark:text-cyan-400 rounded-lg text-xs font-bold flex items-center gap-1.5 transition-colors">
                              <ImageIcon className="w-3.5 h-3.5" />
                  ...
                  <div className="p-5 bg-white dark:bg-[#0D121F] rounded-2xl border border-gray-200 dark:border-slate-800 space-y-5 mt-5 shadow-xs">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 dark:border-white/10 pb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          type="button"
                          onClick={handleResetHeroItems}
                          className="px-2.5 py-1.5 rounded-lg border border-gray-200 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-800 text-gray-600 dark:text-gray-300 text-xs font-bold flex items-center gap-1 transition-colors cursor-pointer"
                          title="استعادة العناصر الافتراضية"
                        >
                          <RotateCcw className="w-3.5 h-3.5" />
                        ...
                        <button
                          type="button"
                          onClick={() => setIsAddingHeroItem(true)}
                    ...
                    {/* General Content Card Info Inputs */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
                      <div>
                        <label className="text-xs font-bold text-gray-500 block mb-1">عنوان كارت المحتوى</label>
                        <input
                          type="text"
                          name="heroContentTitle"
                          defaultValue={platformSettings.heroContentTitle || 'المحتوى'}
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          placeholder="مثال: المحتوى"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-bold text-gray-500 block mb-1">شارة البطاقة (Badge)</label>
                        <input
                          type="text"
                          name="heroContentBadge"
                          defaultValue={platformSettings.heroContentBadge || 'Baccalaureate 2026'}
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          placeholder="مثال: Baccalaureate 2026"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-bold text-gray-500 block mb-1">عنوان الفئة المستهدفة</label>
                        <input
                          type="text"
                          name="heroAudienceTitle"
                          defaultValue={platformSettings.heroAudienceTitle || 'لطلاب البكالوريا'}
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          placeholder="مثال: لطلاب البكالوريا"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-bold text-gray-500 block mb-1">موعد الانطلاق (صندوق التاريخ)</label>
                        <input
                          type="text"
                          name="heroLaunchTitle"
                          defaultValue={platformSettings.heroLaunchTitle || 'البداية 30 اغسطس 2026'}
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          placeholder="مثال: البداية 30 اغسطس 2026"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-bold text-gray-500 block mb-1">توقيت الحصص (صندوق الساعة)</label>
                        <input
                          type="text"
                          name="heroLaunchTime"
                          defaultValue={platformSettings.heroLaunchTime || 'يوم الأحد 6 مساءً'}
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          placeholder="مثال: يوم الأحد 6 مساءً"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-bold text-gray-500 block mb-1">ملاحظة أسفل الأزرار</label>
                        <input
                          type="text"
                          name="heroCurriculumNote"
                          defaultValue={platformSettings.heroCurriculumNote || 'شامل المنهج المصري المعتمد + تطبيقات عملية ومشاريع ذكاء اصطناعي'}
                          className="w-full bg-gray-50 dark:bg-[#090D16]/40 border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          placeholder="مثال: شامل المنهج المعتمد..."
                        />
                      </div>
                    </div>

                    {/* Date Highlight Bottom Card Inputs */}
                    <div className="p-3.5 bg-slate-50 dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 space-y-3">
                      <div className="text-xs font-black text-slate-700 dark:text-slate-200 flex items-center gap-1.5">
                        ...
                        <span>بيانات شريط التاريخ البارز أسفل كارت المحتوى:</span>
                      </div>
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        <div>
                          <label className="text-[11px] font-bold text-gray-500 block mb-1">اليوم (رقم)</label>
                          <input
                            type="text"
                            name="heroDateDay"
                            defaultValue={platformSettings.heroDateDay || '30'}
                            className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-2.5 py-1.5 outline-none focus:border-sky-500 dark:text-white font-mono font-black text-center text-xs"
                          />
                        </div>
                        <div>
                          <label className="text-[11px] font-bold text-gray-500 block mb-1">الشهر والسنة</label>
                          <input
                            type="text"
                            name="heroDateMonthYear"
                            defaultValue={platformSettings.heroDateMonthYear || 'AUG 2026'}
                            className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-2.5 py-1.5 outline-none focus:border-sky-500 dark:text-white font-bold text-center text-xs"
                          />
                        </div>
                        <div>
                          <label className="text-[11px] font-bold text-gray-500 block mb-1">الوصف الفرعي لليوم</label>
                          <input
                            type="text"
                            name="heroDateTime"
                            defaultValue={platformSettings.heroDateTime || 'يوم الأحد 6 مساءً'}
                            className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-2.5 py-1.5 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          />
                        </div>
                        <div>
                          <label className="text-[11px] font-bold text-gray-500 block mb-1">وسم/شارة التاريخ</label>
                          <input
                            type="text"
                            name="heroDateTag"
                            defaultValue={platformSettings.heroDateTag || 'شامل الشرح والتطبيق'}
                            className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-2.5 py-1.5 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                          />
                        </div>
                      </div>
                    ...
                    {isAddingHeroItem && (
                      <motion.div
                        ...
                        className="p-3.5 bg-blue-50/70 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/60 rounded-xl space-y-3"
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            type="button"
                            onClick={() => setIsAddingHeroItem(false)}
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          <input
                            type="text"
                            value={newHeroContentItem}
                            onChange={(e) => setNewHeroContentItem(e.target.value)}
                            onKeyDown={(e) => {
                              if (e.key === 'Enter') {
                                e.preventDefault();
                                handleAddHeroItem();
                            ...
                            placeholder="اكتب عنوان الموضوع الدراسي هنا (مثال: أمن الشبكات والسيبراني)..."
                            className="flex-1 bg-white dark:bg-[#0D121F] border border-blue-300 dark:border-blue-700 rounded-xl px-3 py-2 text-xs font-bold text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-blue-500/20"
                            autoFocus
                          />
                          <div className="flex items-center gap-2">
                            <button
                            ...
                            <button
                              type="button"
                              onClick={() => setIsAddingHeroItem(false)}
                              className="px-3 py-2 bg-gray-200 dark:bg-slate-800 hover:bg-gray-300 dark:hover:bg-slate-700 text-gray-700 dark:text-gray-300 rounded-xl text-xs font-bold transition-colors cursor-pointer"
                            >
                              إلغاء
                            </button>
                          </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-xs font-bold text-gray-500 px-1">
                        <span>قائمة العناصر الحالية ({tempHeroContentItems.length} عنصر):</span>
                        <span className="text-[11px] text-gray-400">يمكنك التعديل والحذف والترتيب</span>
                      </div>

                      {tempHeroContentItems.length === 0 ? (
                        <div className="p-6 text-center border-2 border-dashed border-gray-200 dark:border-slate-800 rounded-xl text-gray-400 text-xs font-bold">
                          لا توجد عناصر مضافة حالياً. اضغط "إضافة عنصر جديد" للبدء.
                        </div>
                      ) : (
                        <div className="space-y-2">
                          {tempHeroContentItems.map((item, idx) => (
                            <div
                              key={idx}
                              className="p-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl flex items-center justify-between gap-3 hover:border-blue-400 dark:hover:border-blue-500 transition-colors"
                            >
                              {editingHeroItemIndex === idx ? (
                                <div className="flex-1 flex items-center gap-2">
                                  <input
                                    type="text"
                                    value={editingHeroItemValue}
                                    onChange={(e) => setEditingHeroItemValue(e.target.value)}
                                    onKeyDown={(e) => {
                                      if (e.key === 'Enter') {
                                        e.preventDefault();
                                        handleSaveEditHeroItem(idx);
                                      }
                                    }}
                                    className="flex-1 bg-white dark:bg-[#0D121F] border border-blue-500 rounded-lg px-3 py-1.5 text-xs font-bold text-gray-900 dark:text-white outline-none"
                                    autoFocus
                                  />
                                  <button
                                    type="button"
                                    onClick={() => handleSaveEditHeroItem(idx)}
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => setEditingHeroItemIndex(null)}
                                    className="p-1.5 bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 text-gray-600 dark:text-gray-300 rounded-lg transition-colors cursor-pointer"
                                    title="إلغاء"
                                  >
                                    <X className="w-3.5 h-3.5" />
                                  </button>
                                ...
                                <>
                                  ...
                                  <div className="flex items-center gap-1 shrink-0">
                                    <button
                                      ...
                                      className="p-1.5 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 disabled:opacity-30 disabled:hover:text-gray-400 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                                      title="تحريك لأعلى"
                                    >
                                    ...
                                    <button
                                      type="button"
                                      disabled={idx === tempHeroContentItems.length - 1}
                                    ...
                                    <button
                                      type="button"
                                      onClick={() => handleStartEditHeroItem(idx, item)}
                                      className="p-1.5 text-gray-500 hover:text-amber-600 dark:hover:text-amber-400 rounded-lg hover:bg-amber-50 dark:hover:bg-amber-950/30 transition-colors cursor-pointer"
                                      title="تعديل العنصر"
                                    >
                                    ...
                                    <button
                                      type="button"
                                      onClick={() => handleDeleteHeroItem(idx)}
                                      className="p-1.5 text-gray-400 hover:text-rose-600 dark:hover:text-rose-400 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors cursor-pointer"
                                      title="حذف العنصر"
                                    >
                                      <Trash2 className="w-3.5 h-3.5" />
                                    </button>
              ...
              <div className="bg-gray-50/50 dark:bg-[#090D16]/30 p-6 rounded-2xl border border-gray-150 dark:border-slate-800 md:col-span-2 space-y-4">
                <h3 className="text-base font-black text-gray-800 dark:text-white flex items-center gap-2">
                  <Edit3 className="w-5 h-5 text-sky-600" /> تخصيص مسميات ووصف الأقسام بالواجهة
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <h4 className="text-xs font-black text-sky-600">إعدادات قسم الصفوف الدراسية</h4>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs"
                      />
                    </div>
                    <div>
                  ...
                  <div className="space-y-3 md:col-span-2 border-t border-gray-100 dark:border-slate-800 pt-4">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-800">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-sky-500 dark:text-white font-bold text-xs mb-3"
                        />
                      </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none text-xs dark:text-white font-bold"
                              />
                            </div>
                            <div>
                              ...
                              <div className="w-full space-y-2">
                                <div className="grid grid-cols-2 gap-2">
                                  <input
                                    ...
                                    className="bg-white dark:bg-[#0D121F] border rounded-lg px-2 py-1 text-xs font-bold dark:text-white"
                                  />
                                  <select
                                ...
                                <textarea
                                  ...
                                  rows={2}
                                  className="w-full bg-white dark:bg-[#0D121F] border rounded-lg px-2 py-1 text-xs dark:text-white"
                                />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div>
                              ...
                              <input
                                ...
                                step="any"
                                value={newStatValue}
                                onChange={(e) => setNewStatValue(parseFloat(e.target.value) || 0)}
                                className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none text-xs dark:text-white font-bold"
                              />
                            </div>
                            <div>
                            ...
                            {editingStatId === stat.id ? (
                              <div className="w-full space-y-2">
                                <input
                                  ...
                                  onChange={(e) => setEditingStatValue(parseFloat(e.target.value) || 0)}
                                  className="w-full bg-white dark:bg-[#0D121F] border rounded px-2 py-1 text-xs dark:text-white font-bold"
                                />
                                <input
                                  type="text"
                            ...
                            {editingStepId === step.id ? (
                              <div className="w-full space-y-2">
                                <input
                                  ...
                                  className="w-full bg-white dark:bg-[#0D121F] border rounded px-2 py-1 text-xs font-bold dark:text-white"
                                />
                                <textarea
                                  value={editingStepDesc}
                                  onChange={(e) => setEditingStepDesc(e.target.value)}
                                  rows={2}
                                  className="w-full bg-white dark:bg-[#0D121F] border rounded px-2 py-1 text-xs dark:text-white"
                                />
                                <div className="flex gap-1">
                  ...
                  <div className="space-y-4 md:col-span-2 border-t border-gray-100 dark:border-slate-800 pt-4">
                    ...
                    <div className="bg-sky-50/40 dark:bg-sky-950/20 border border-sky-100 dark:border-sky-900/30 rounded-2xl p-4 space-y-4">
                      ...
                      {/* Add FAQ Form */}
                      {isAddingFaq && (
                        <div className="bg-white dark:bg-[#0D121F] p-4 rounded-xl border border-sky-200 dark:border-sky-800/50 space-y-3 animate-fadeIn">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full bg-gray-50 dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 text-xs font-medium dark:text-white outline-none focus:border-sky-500"
                            />
                          </div>
                          <div>
                      ...
                      <div className="space-y-2 max-h-96 overflow-y-auto pr-1">
                        {tempFaqs.length === 0 ? (
                          ...
                          tempFaqs.map((faq, index) => (
                            <div
                              key={faq.id || index}
                              className="bg-white dark:bg-[#111827] p-3 rounded-xl border border-gray-200 dark:border-slate-800 space-y-2 transition-all hover:border-sky-500/40"
                            >
                              {editingFaqId === faq.id ? (
                                <div className="space-y-2">
                                  <div>
                                    ...
                                    <input
                                      ...
                                      className="w-full bg-gray-50 dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-2.5 py-1.5 text-xs font-bold dark:text-white outline-none focus:border-sky-500"
                                    />
                                  </div>
                                  <div>
                                    ...
                                    <textarea
                                      ...
                                      className="w-full bg-gray-50 dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-2.5 py-1.5 text-xs font-medium dark:text-white outline-none focus:border-sky-500"
                                    />
                                  </div>
                                  <div className="flex items-center gap-2 justify-end pt-1">
                                    <button
                                ...
                                <div className="flex items-start justify-between gap-3">
                                  <div className="space-y-1 flex-1">
                                    <div className="flex items-center gap-2">
                                      <span className="w-5 h-5 rounded-full bg-sky-500/10 dark:bg-cyan-400/10 text-sky-600 dark:text-cyan-400 text-[10px] font-black flex items-center justify-center shrink-0">
                                        {index + 1}
                                      </span>
                    ...
                    <div className="bg-emerald-50/30 dark:bg-emerald-950/10 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl p-4">
                      ...
                      {isAddingPaymentMethod && (
                        <div className="bg-white dark:bg-[#111827] border border-gray-150 dark:border-slate-800 rounded-xl p-3 mb-4 animate-in fade-in zoom-in-95">
                          <div className="grid grid-cols-1 gap-3 mb-3">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full bg-gray-50 dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 outline-none focus:border-emerald-500 dark:text-white font-bold text-xs"
                              />
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                className="w-full bg-gray-50 dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 outline-none focus:border-emerald-500 dark:text-white font-bold text-xs text-right"
                                dir="ltr"
                              />
                            </div>
                          </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        {tempPaymentMethods.map((method, idx) => (
                          <div key={method.id || idx} className="bg-white dark:bg-[#0D121F] border border-gray-150 dark:border-slate-800 p-3 rounded-xl flex flex-col gap-2 relative group">
                            <div className="flex items-center justify-between">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-green-50 dark:bg-green-900/10 p-3 rounded-xl border border-green-100 dark:border-green-800/30">
                        ...
                        <input
                          ...
                          className="w-full bg-white dark:bg-[#0D121F] border border-green-200 dark:border-green-800/30 rounded-xl px-3 py-2 outline-none focus:border-green-500 dark:text-white font-bold text-xs"
                          dir="ltr"
                        />
                  ...
                  <div className="space-y-4 md:col-span-2 border-t border-gray-100 dark:border-slate-800 pt-5">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="text-sm font-black text-rose-500">إعدادات الدفع المالي</h4>
                      <div className="text-[10.5px] text-gray-500 font-bold bg-gray-50 dark:bg-[#111827] px-3 py-1.5 rounded-lg border border-gray-100 dark:border-slate-800">
                    ...
                    <div className="bg-rose-50/30 dark:bg-rose-950/10 border border-rose-100 dark:border-rose-900/30 rounded-2xl p-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full max-w-sm bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-rose-500 dark:text-white font-bold text-xs font-mono text-right"
                          dir="ltr"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-purple-50/30 dark:bg-purple-950/10 border border-purple-100 dark:border-purple-900/30 rounded-2xl p-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full max-w-sm bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-purple-500 dark:text-white font-bold text-xs font-mono text-right"
                          dir="ltr"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50/30 dark:bg-blue-950/10 border border-blue-100 dark:border-blue-900/30 rounded-2xl p-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 outline-none focus:border-blue-500 dark:text-white font-bold text-xs resize-none h-24"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 md:col-span-2 border-t border-gray-100 dark:border-slate-800 pt-4">
                    ...
                    {isAddingSubject && (
                      <div className="bg-white dark:bg-[#111827] p-4 rounded-xl border border-dashed border-cyan-500/30 space-y-3 mb-4 animate-in slide-in-from-top-2 duration-300">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 outline-none focus:border-cyan-500 dark:text-white font-bold text-xs"
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                      {tempSubjects.map((subject, idx) => (
                        <div key={subject.id || idx} className="bg-white dark:bg-[#0D121F] border border-gray-150 dark:border-slate-800 p-3 rounded-xl flex items-center justify-between group">
              ...
              <div className="bg-gray-50/50 dark:bg-[#090D16]/30 p-6 rounded-2xl border border-gray-150 dark:border-slate-800 md:col-span-2 space-y-4">
                <div className="flex items-center justify-between border-b border-gray-200/60 dark:border-slate-800 pb-3">
                  <h3 className="text-base font-black text-gray-800 dark:text-white flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 gap-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl p-3 outline-none focus:border-sky-500 dark:text-white font-medium text-xs leading-relaxed"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl p-3 outline-none focus:border-emerald-500 dark:text-white font-medium text-xs leading-relaxed"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl p-3 outline-none focus:border-purple-500 dark:text-white font-medium text-xs leading-relaxed"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-end pt-4 border-t border-gray-100 dark:border-slate-800">
              <button
                ...
                className="bg-sky-600 dark:bg-cyan-500 text-white dark:text-[#0D0D12] font-black py-3.5 px-10 rounded-xl hover:bg-sky-700 dark:hover:bg-cyan-600 hover:-translate-y-0.5 shadow-lg shadow-sky-500/20 dark:shadow-cyan-500/20 transition-all flex items-center justify-center gap-2 text-sm cursor-pointer"
              >
                {savingSettings ? (
                  <>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className={`overflow-auto max-h-[600px] relative rounded-2xl border border-gray-100 dark:border-slate-800/50 scrollbar-thin ${(activeTab === 'payments' || activeTab === 'subscription_requests' || activeTab === 'support_requests') ? 'p-6 bg-gray-50/30 dark:bg-[#090D16]/30' : ''}`}
            >
              {activeTab === 'support_requests' ? (
                ...
                <div className="space-y-6 animate-in fade-in duration-300">
                  <div className="flex justify-between items-center bg-white dark:bg-[#111827] p-5 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm">
                    <div>
                      <h3 className="text-lg font-black text-gray-900 dark:text-white flex items-center gap-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2.5 bg-white dark:bg-[#111827] p-4 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm">
                    ...
                    {users.filter(u => {
                      ...
                      users.filter(u => {
                        ...
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          className="bg-white dark:bg-[#111827] rounded-[2.5rem] p-6 border border-gray-100 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all relative overflow-hidden group"
                        >
                          <div className="flex items-start justify-between mb-5">
                            <div className="flex items-center gap-4">
                              <div className="w-14 h-14 rounded-2xl bg-gray-50 dark:bg-[#090D16] flex items-center justify-center text-sky-600 dark:text-cyan-400 border border-gray-100 dark:border-slate-800 group-hover:scale-110 transition-transform shadow-inner">
                          ...
                          <div className="space-y-3 mb-6 bg-gray-50/50 dark:bg-[#090D16]/30 p-4 rounded-2xl border border-gray-100 dark:border-slate-800">
                      ...
                      <div className="col-span-full py-24 bg-white dark:bg-[#111827] rounded-[3rem] border border-dashed border-gray-200 dark:border-slate-800 text-center">
                        <div className="w-20 h-20 bg-gray-50 dark:bg-[#090D16] rounded-3xl flex items-center justify-center mx-auto mb-5 text-gray-300 dark:text-gray-800">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex bg-gray-100 dark:bg-[#090D16] p-1.5 rounded-2xl border border-gray-200 dark:border-slate-800 mb-4">
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-black transition-all ${
                        paymentSubTab === 'courses' 
                          ? 'bg-white dark:bg-[#111827] text-rose-600 dark:text-rose-400 shadow-md' 
                    ...
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-black transition-all ${
                        paymentSubTab === 'reviews' 
                          ? 'bg-white dark:bg-[#111827] text-purple-600 dark:text-purple-400 shadow-md' 
                          : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'
                      }`}
                    >
                  ...
                  <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white dark:bg-[#111827] p-4 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm">
                    <div className="flex items-center gap-3 w-full md:w-auto">
                      <div className="relative flex-1 md:min-w-[300px]">
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl pr-10 pl-4 py-2.5 outline-none focus:border-rose-500/50 focus:ring-2 focus:ring-rose-500/20 text-sm transition-all text-gray-900 dark:text-white font-bold"
                        />
                      </div>
                    </div>
                    
                    <div className="flex bg-gray-100 dark:bg-[#090D16] p-1 rounded-xl w-full md:w-auto overflow-x-auto">
                      {[
                        { id: 'all', label: 'الكل' },
                        ...
                        <button
                          ...
                          className={`flex-1 md:flex-none px-4 py-2 rounded-lg text-xs font-black whitespace-nowrap transition-all ${
                            paymentStatusFilter === status.id 
                              ? 'bg-white dark:bg-[#111827] text-rose-600 dark:text-rose-400 shadow-sm' 
                              : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'
                          }`}
                        >
                          {status.label}
                  ...
                  {(paymentSubTab === 'courses' ? payments : reviewPayments).filter(p => {
                    ...
                    <div className="py-16 text-center bg-white dark:bg-[#111827] rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm">
                    ...
                    <div className="bg-white dark:bg-[#111827] rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden">
                      <div className="overflow-x-auto">
                        <table className="w-full text-right border-collapse">
                          <thead>
                            <tr className="border-b border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-[#15151F]">
                          ...
                          <tbody>
                            {(paymentSubTab === 'courses' ? payments : reviewPayments).filter(p => {
                              ...
                              return (
                                <tr key={payment.id} className="border-b border-gray-100 dark:border-slate-800 hover:bg-gray-50/30 dark:hover:bg-[#1e1e2d]/40 transition-colors animate-in fade-in duration-200">
                                  {/* Student / Sender Data */}
                                    ...
                                    <div className="inline-flex justify-center whitespace-nowrap">
                                      {paymentSubTab === 'courses' && payment.screenshotUrl === 'uploading...' ? (
                                        ...
                                        <button
                                          ...
                                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gray-50 hover:bg-gray-100 dark:bg-[#15151F] dark:hover:bg-gray-800 border border-gray-150 dark:border-slate-800 text-xs font-black text-sky-600 dark:text-cyan-400 transition-all cursor-pointer border-0"
                                        >
                ...
                <div className="space-y-6 p-6 bg-gray-50/30 dark:bg-[#090D16]/30">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white dark:bg-[#111827] p-4 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm">
                    <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto items-center">
                      <div className="relative w-full md:w-[300px]">
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl pr-10 pl-4 py-2.5 outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 text-sm transition-all text-gray-900 dark:text-white font-bold"
                        />
                      </div>
                      ...
                      <div className="relative w-full md:w-[200px]">
                        ...
                        <select
                          ...
                          className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl pr-10 pl-4 py-2.5 outline-none focus:border-sky-500 text-sm transition-all text-gray-700 dark:text-gray-300 font-bold appearance-none cursor-pointer"
                        >
                          <option value="all">كل الصفوف والمسارات</option>
                          <option value="الأول الثانوي">المستوى الأول (مبتدئ)</option>
                          <option value="الثاني الثانوي">المستوى الثاني (متوسط)</option>
                    ...
                    <div className="flex gap-2">
                      <div className="bg-[#00B4D8]/10 text-sky-600 dark:bg-[#D4AF37]/10 dark:text-cyan-400 border border-sky-500/20 dark:border-cyan-400/20 px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1">
                  ...
                  {courses.filter(course => {
                    ...
                    <div className="bg-white dark:bg-[#111827] p-16 text-center text-gray-400 dark:text-gray-500 rounded-2xl border border-gray-150 dark:border-slate-800 font-bold text-sm">
                      <div className="flex flex-col items-center justify-center gap-3">
                        <div className="w-16 h-16 rounded-3xl bg-gray-50 dark:bg-[#090D16] border border-dashed border-gray-200 dark:border-slate-800 flex items-center justify-center text-gray-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {courses.filter(course => {
                        ...
                        <div 
                          key={course.id}
                          className="bg-white dark:bg-[#111827] rounded-3xl border border-gray-150 dark:border-slate-800 shadow-sm overflow-hidden flex flex-col justify-between hover:shadow-md transition-all relative group"
                        >
                          {/* Course Thumbnail & Status Banner */}
                          <div className="relative h-44 bg-gray-100 dark:bg-[#090D16] overflow-hidden">
                            {course.imageUrl ? (
                          ...
                          <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1.5 mb-2">
                                <span className="bg-blue-50 dark:bg-blue-950/30 text-sky-600 px-2 py-0.5 rounded-md text-[10px] font-bold">
                            ...
                            <div className="border-t border-gray-100 dark:border-slate-800 pt-3 space-y-3">
                              ...
                              <div className="flex items-center justify-between text-xs font-bold text-gray-500 dark:text-gray-400">
                                <div className="flex items-center gap-1.5">
                                  <div className="w-5 h-5 bg-[#00B4D8]/10 text-sky-600 rounded-full flex items-center justify-center">
                                ...
                                <button
                                  ...
                                  className="text-sky-600 hover:underline cursor-pointer flex items-center gap-1 bg-[#00B4D8]/5 hover:bg-[#00B4D8]/10 px-2 py-1 rounded-lg"
                                >
              ...
              <thead className="sticky top-0 z-20 bg-white dark:bg-[#111827]">
                <tr className="border-b border-gray-100 dark:border-slate-800">
                  <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">الاسم والبيانات</th>
                  <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">البريد الإلكتروني</th>
                  <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">رقم الهاتف</th>
                  {activeTab === 'students' && <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">الصف الدراسي</th>}
                  {activeTab === 'approvals' && <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">نوع الحساب / التفاصيل</th>}
                  {activeTab === 'teachers' && <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">المادة</th>}
                  {activeTab === 'approvals' && (
                    <>
                      <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">المحافظة / المدرسة</th>
                      <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">هاتف ولي الأمر</th>
                    </>
                  )}
                  <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-right shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">تاريخ التسجيل</th>
                  <th className="sticky top-0 bg-white dark:bg-[#111827] py-3.5 px-4 text-xs font-black text-gray-400 z-10 text-center shadow-[0_1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_1px_0_rgba(255,255,255,0.05)]">التحكم والعمليات</th>
                </tr>
              </thead>
              <tbody>
                {filteredUsers.length === 0 ? (
                      ...
                      <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        {(searchQuery || gradeFilter !== 'all' || subjectFilter !== 'all' || studentTrackFilter !== 'all') && (
                          <button
                            ...
                            className="mt-2 text-xs font-black text-sky-600 dark:text-cyan-400 hover:underline flex items-center gap-1.5"
                          >
                            <RotateCcw className="w-3.5 h-3.5" />
                  ...
                  <tr key={user.id} className="border-b border-gray-50 dark:border-slate-800/50 hover:bg-gray-50 dark:hover:bg-[#0D0D12] transition-colors">
                    ...
                    {activeTab === 'students' && (
                      <td className="py-2.5 px-4">
                        <div className="flex flex-col items-start gap-1">
                          <span className="bg-blue-50 text-sky-600 dark:bg-blue-950/40 dark:text-blue-400 border border-blue-100 dark:border-blue-900/50 py-0.5 px-2.5 rounded-lg text-[11px] font-black inline-block">
                            {user.grade || '-'}
                          </span>
                          {user.branch && (
                          ...
                          <span className="text-[11px] font-bold text-gray-500 dark:text-gray-400">
                            {user.role === 'teacher' ? (user.subject || '-') : user.role === 'parent' ? `هاتف الطالب: ${user.studentPhone || '-'}` : (
                              <>
                                ...
                                {user.educationSystem === 'baccalaureate' && ' (بكالوريا)'}
                              </>
                            )}
                          </span>
                        </div>
                        ...
                        {activeTab === 'approvals' ? (
                          <>
                            ...
                            <button 
                              ...
                              className="p-1.5 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors border border-gray-100 dark:border-slate-800"
      ...
      <AnimatePresence>
        {rejectionModalOpen && selectedPayment && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-sm relative z-10 shadow-2xl overflow-hidden p-6">
              ...
              <form onSubmit={handleRejectPaymentSubmit}>
                <div className="mb-4 space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl p-3 outline-none focus:border-red-500/50 focus:ring-2 focus:ring-red-500/20 text-xs font-bold text-gray-900 dark:text-white min-h-[100px] resize-none"
                  />
                </div>
      ...
      <AnimatePresence>
        {viewModalOpen && selectedUser && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-sm relative z-10 shadow-2xl max-h-[85vh] flex flex-col overflow-hidden">
              {/* Fixed Header */}
              <div className="flex justify-between items-center px-5 py-4 border-b border-gray-100 dark:border-slate-800 shrink-0">
                <h3 className="text-lg font-black text-gray-900 dark:text-white flex items-center gap-2">
                  <Eye className="w-5 h-5 text-sky-600 dark:text-cyan-400" /> تفاصيل حساب المستخدم
                </h3>
              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-4">
                {/* Profile Card Header */}
                <div className="flex items-center gap-3 bg-gray-50/50 dark:bg-[#090D16]/30 p-3 rounded-2xl border border-gray-100 dark:border-slate-800">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center font-black text-xl text-white shadow-md shrink-0 ${
                  selectedUser.role === 'teacher' ? 'bg-purple-500 shadow-purple-500/20' : selectedUser.role === 'parent' ? 'bg-amber-500 shadow-amber-500/20' : selectedUser.role === 'admin' ? 'bg-red-500 shadow-red-500/20' : 'bg-[#00B4D8] shadow-sky-500/20'
                }`}>
              ...
              <div className="space-y-2.5 text-sm font-bold">
                {/* Email */}
                <div className="flex items-center p-2.5 bg-gray-50 dark:bg-[#090D16] rounded-xl border border-gray-100 dark:border-slate-800">
                ...
                {/* Phone */}
                <div className="flex items-center p-2.5 bg-gray-50 dark:bg-[#090D16] rounded-xl border border-gray-100 dark:border-slate-800">
                  <div className="w-8.5 h-8.5 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-sky-600 flex items-center justify-center shrink-0 ml-2.5">
                    ...
                    <div className="flex items-center p-2.5 bg-gray-50 dark:bg-[#090D16] rounded-xl border border-gray-100 dark:border-slate-800">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span className="text-gray-900 dark:text-white text-xs block">
                          {selectedUser.educationSystem === 'azhar' ? 'أزهري' : selectedUser.educationSystem === 'baccalaureate' ? 'بكالوريا' : 'عام'}
                        </span>
                      </div>
                    </div>
              ...
              {/* Fixed Footer */}
              <div className="p-5 border-t border-gray-100 dark:border-slate-800 shrink-0">
                <button 
                  onClick={() => setViewModalOpen(false)} 
                  className="w-full px-5 py-2.5 bg-[#00B4D8] hover:bg-[#0077B6] text-white rounded-xl transition-all font-bold text-xs shadow-md shadow-sky-500/10"
                >
                  إغلاق النافذة
                </button>
              </div>
      ...
      <AnimatePresence>
        {editModalOpen && selectedUser && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-md relative z-10 shadow-2xl p-6">
              ...
              <form onSubmit={handleEditSave} className="space-y-4">
                <div>
                  ...
                  <input type="text" value={editFormData.name || ''} onChange={e => setEditFormData({...editFormData, name: e.target.value})} className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-sky-500 dark:text-white font-bold" required />
                </div>
                <div>
                  <label className="text-xs font-bold text-gray-500 block mb-1">رقم الهاتف</label>
                  <input type="tel" value={editFormData.phone || ''} onChange={e => setEditFormData({...editFormData, phone: e.target.value})} className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-sky-500 dark:text-white font-bold" />
                </div>
                {selectedUser.role === 'student' && (
                  <div>
                    <label className="text-xs font-bold text-gray-500 block mb-1">الصف الدراسي</label>
                    <input type="text" value={editFormData.grade || ''} onChange={e => setEditFormData({...editFormData, grade: e.target.value})} className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-sky-500 dark:text-white font-bold" />
                  </div>
                )}
                <div>
                  <label className="text-xs font-bold text-gray-500 block mb-1">كلمة المرور (إن وجدت)</label>
                  <input type="text" value={editFormData.password || ''} onChange={e => setEditFormData({...editFormData, password: e.target.value})} className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-sky-500 dark:text-white font-bold" />
                </div>
                {selectedUser.role === 'student' && (
                  <div>
                    <label className="text-xs font-bold text-gray-500 block mb-1">رصيد المحفظة (ج.م)</label>
                    <input type="number" min="0" step="any" value={editFormData.balance !== undefined ? editFormData.balance : ''} onChange={e => setEditFormData({...editFormData, balance: e.target.value ? Number(e.target.value) : 0})} className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 outline-none focus:border-sky-500 dark:text-white font-bold" />
                  </div>
                )}
                <button type="submit" disabled={isSaving} className="w-full bg-sky-600 dark:bg-cyan-500 text-white font-bold py-3 rounded-xl hover:bg-opacity-90 transition-all mt-4 flex justify-center items-center gap-2 shadow-lg">
        ...
        {printModalOpen && selectedUser && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, scale: 1 }} 
              exit={{ opacity: 0, scale: 0.95 }} 
              className="bg-gray-100 dark:bg-[#090D16] rounded-3xl w-full max-w-5xl relative z-10 shadow-2xl flex flex-col md:flex-row overflow-hidden max-h-[92vh]"
            >
              
              {/* Settings and options Panel (Left column) */}
              <div className="w-full md:w-[40%] bg-white dark:bg-[#111827] p-6 border-b md:border-b-0 md:border-l border-gray-200 dark:border-slate-800 flex flex-col justify-between overflow-y-auto">
                <div className="space-y-6">
                  {/* Modal Header */}
                  <div className="flex justify-between items-center pb-4 border-b border-gray-100 dark:border-slate-800">
                    <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2 text-sm font-bold outline-none focus:border-purple-500 dark:text-white"
                        ...
                        <button 
                          ...
                          className={`py-2 px-1 rounded-xl text-[10px] font-black border transition-all ${
                            printDateRange === 'all' 
                              ...
                              : 'bg-gray-50 border-gray-200 text-gray-500 dark:bg-[#090D16] dark:border-slate-800 dark:text-gray-400'
                          }`}
                        >
                          شامل
                        </button>
                      ...
                      <div className="grid grid-cols-2 gap-2 animate-in fade-in slide-in-from-top-2 duration-200">
                        <div>
                          ...
                          <input 
                            ...
                            className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-1.5 text-xs font-bold outline-none focus:border-purple-500 dark:text-white" 
                          />
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        rows={3}
                        className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs font-bold outline-none focus:border-purple-500 dark:text-white resize-none leading-relaxed"
              ...
              <div className="w-full md:w-[60%] p-6 md:p-8 overflow-y-auto bg-gray-200 dark:bg-[#090D16] flex flex-col items-center justify-start gap-4">
                          ...
                          {selectedUser.role === 'student' && (
                            <>
                              <div className="flex justify-between border-b border-slate-100 pb-1.5">
                                ...
                                <span className="text-sky-600">{selectedUser.grade || 'غير محدد'}</span>
                              </div>
                              <div className="flex justify-between border-b border-slate-100 pb-1.5">
                                <span className="text-slate-400 font-medium">نوع التعليم:</span>
                                <span className="text-sky-600">
                                  {selectedUser.educationSystem === 'azhar' ? 'ثانوي أزهري' : selectedUser.educationSystem === 'baccalaureate' ? 'بكالوريا' : 'ثانوي عام'}
                                </span>
                              </div>
                              {selectedUser.branch && (
                                <div className="flex justify-between border-b border-slate-100 pb-1.5">
                        ...
                        {selectedUser.role === 'student' ? (
                          <div className="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm">
                              ...
                              <span className="text-base font-black text-sky-600">{selectedUserProgress.reduce((acc, prog) => acc + (Array.isArray(prog.completedLessons) ? prog.completedLessons.length : 0), 0)} درس</span>
                            </div>
                            <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm">
                          ...
                          <div className="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm">
                              ...
                              <span className="text-base font-black text-sky-600">92%</span>
                            </div>
                            <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm">
                              <span className="text-[10px] text-slate-400 block mb-1">رصيد المحفظة</span>
              ...
              {selectedUser.role === 'student' ? (
                <div className="grid grid-cols-3 gap-6 text-center">
                  ...
                  <div className="bg-white p-3 rounded-lg border border-slate-200">
                    ...
                    <span className="text-lg font-black text-sky-600">{selectedUserProgress.reduce((acc, prog) => acc + (Array.isArray(prog.completedLessons) ? prog.completedLessons.length : 0), 0)} درس</span>
                  </div>
                  <div className="bg-white p-3 rounded-lg border border-slate-200">
      ...
      <AnimatePresence>
        {selectedCourseForStudents && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-3xl relative z-10 shadow-2xl p-6 overflow-hidden flex flex-col max-h-[85vh] text-right" dir="rtl">
              <div className="flex justify-between items-center pb-4 border-b border-gray-100 dark:border-slate-800 mb-4 shrink-0">
                <div>
                  <h3 className="text-xl font-black text-gray-900 dark:text-white flex items-center gap-2">
                    <Users className="w-6 h-6 text-sky-600 dark:text-cyan-400" />
                    الطلاب المشتركين في الكورس
                  </h3>
                  <p className="text-xs text-gray-400 dark:text-gray-500 font-bold mt-1">كورس: <span className="text-sky-600 dark:text-cyan-400">{selectedCourseForStudents.title}</span></p>
                </div>
                  ...
                  return (
                    <div className="space-y-3">
                      <div className="overflow-x-auto">
                        <table className="w-full text-right border-collapse">
                          <thead>
                            <tr className="border-b border-gray-100 dark:border-slate-800 text-xs text-gray-400 font-bold">
      ...
      <AnimatePresence>
        {selectedCourseForEdit && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-lg relative z-10 shadow-2xl p-6 text-right max-h-[90vh] overflow-y-auto" style={{ maxHeight: "90vh", overflowY: "auto" }} dir="rtl">
              <div className="flex justify-between items-center pb-4 border-b border-gray-100 dark:border-slate-800 mb-4 shrink-0">
                <h3 className="text-xl font-black text-gray-900 dark:text-white flex items-center gap-2">
              ...
              <form onSubmit={handleEditCourseSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2.5 outline-none focus:border-sky-500 text-sm font-bold text-gray-900 dark:text-white"
                    required
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2.5 outline-none focus:border-sky-500 text-sm font-bold text-gray-700 dark:text-gray-300 cursor-pointer"
                    >
                      <option value="الأول الثانوي">المستوى الأول (مبتدئ)</option>
                      <option value="الثاني الثانوي">المستوى الثاني (متوسط)</option>
                      <option value="الثالث الثانوي">المستوى الثالث (متقدم)</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-2.5 outline-none focus:border-sky-500 text-sm font-bold text-gray-900 dark:text-white font-mono text-left"
                    required
                    min={0}
                  />
                </div>
      ...
      <AnimatePresence>
        {courseToDelete && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-md relative z-10 shadow-2xl p-6 text-right max-h-[90vh] overflow-y-auto" style={{ maxHeight: "90vh", overflowY: "auto" }} dir="rtl">
              <div className="text-center mb-6">
                <div className="w-16 h-16 bg-red-100 dark:bg-red-900/30 text-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
