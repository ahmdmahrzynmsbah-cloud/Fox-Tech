...
export default function CourseStudentsTable({ students, course, onRemoveStudent, onUpdateStudent }: CourseStudentsTableProps) {
  ...
  const SortIcon = ({ field }: { field: SortField }) => {
    ...
    return sortOrder === 'asc' ? <ChevronUp className="w-3.5 h-3.5 text-sky-600" /> : <ChevronDown className="w-3.5 h-3.5 text-sky-600" />;
  };
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#111827] rounded-2xl border border-gray-200 dark:border-slate-800 shadow-sm overflow-hidden" dir="rtl">
      
      {/* Top Toolbar */}
      <div className="p-4 border-b border-gray-200 dark:border-slate-800 flex flex-col md:flex-row gap-4 justify-between items-center bg-gray-50/50 dark:bg-[#090D16]/30">
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full sm:w-64 pl-4 pr-10 py-2 text-sm bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-sky-500 outline-none"
            />
          </div>
          {/* Grade Filter */}
          <select
            ...
            className="w-full sm:w-auto px-4 py-2 text-sm bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-sky-500 outline-none"
          >
        ...
        {selectedIds.size > 0 && (
          <div className="flex items-center gap-2 flex-wrap animate-in fade-in zoom-in duration-200">
            ...
            <button onClick={() => toast.success('جاري التصدير...')} className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-sky-600 hover:bg-blue-100 rounded-lg text-xs font-bold transition-colors border border-blue-100">
      ...
      {/* Table Container */}
      <div 
        className="flex-1 overflow-auto bg-white dark:bg-[#111827]"
        style={{ minHeight: '400px', maxHeight: '600px' }}
      >
        <div className="min-w-[1000px]">
          {/* Sticky Header */}
          <div className="sticky top-0 z-20 bg-gray-50 dark:bg-[#090D16] border-b border-gray-200 dark:border-slate-800 flex items-center px-4 py-3 text-xs font-black text-gray-500 dark:text-gray-400">
          ...
          <div className="flex flex-col relative z-0">
            {paginatedData.map(student => {
              ...
              return (
                <div
                  key={student.id}
                  className={`flex items-center px-4 py-3 border-b border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-[#0D0D12]/50 transition-colors cursor-pointer ${isSelected ? 'bg-blue-50/50 dark:bg-blue-900/10' : ''}`}
                ...
                >
                  ...
                  <div className="w-32 flex-shrink-0">
                    <span className="bg-blue-50 dark:bg-blue-900/20 text-sky-600 px-2 py-1 rounded-md text-[11px] font-bold truncate">
                      {student.grade || '-'}
                    </span>
                  </div>
                  ...
                  <div className="flex-1 flex items-center justify-center gap-2" onClick={e => e.stopPropagation()}>
                    ...
                    <button 
                      onClick={() => setSelectedStudent(student)}
                      className="p-1.5 text-gray-400 hover:text-sky-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors"
                      title="عرض التفاصيل"
                    >
      ...
      {/* Pagination Footer */}
      <div className="p-4 border-t border-gray-200 dark:border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50/30 dark:bg-[#090D16]/10">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="text-xs border border-gray-200 dark:border-slate-800 rounded-md px-2 py-1 bg-white dark:bg-[#0D121F] outline-none"
            >
        ...
        {selectedStudent && (
          <div className="fixed inset-0 z-50 flex justify-end">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-md bg-white dark:bg-[#111827] shadow-2xl h-full flex flex-col border-l border-gray-200 dark:border-slate-800"
            >
              {/* Drawer Header */}
              <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between bg-gray-50/50 dark:bg-[#090D16]/30">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                {/* Profile Card */}
                <div className="flex flex-col items-center text-center p-6 bg-gradient-to-b from-[#00B4D8]/5 to-transparent rounded-2xl border border-sky-500/10">
                  ...
                  <div className="mt-4 flex gap-2 w-full">
                    {!isEditingStudent ? (
                      <button onClick={() => handleStartEdit(selectedStudent)} className="flex-1 py-2 bg-white dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-xl text-xs font-bold text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-[#2D2D3D] transition-colors flex items-center justify-center gap-1.5">
                ...
                <div className="space-y-4">
                  ...
                  {isEditingStudent ? (
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gray-50 dark:bg-[#090D16] p-3 rounded-xl border border-gray-100 dark:border-slate-800 col-span-2">
                      ...
                      <div className="bg-gray-50 dark:bg-[#090D16] p-3 rounded-xl border border-gray-100 dark:border-slate-800">
        ...
        {confirmDialog?.isOpen && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white dark:bg-[#111827] rounded-2xl p-6 shadow-2xl max-w-sm w-full border border-gray-100 dark:border-slate-800"
            >
