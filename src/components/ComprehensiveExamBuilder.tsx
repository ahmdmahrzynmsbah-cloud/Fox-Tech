    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto bg-black/60 backdrop-blur-sm" dir="rtl">
        <motion.div
          ...
          className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] text-right border border-gray-100 dark:border-slate-800"
        >
          {/* Header */}
          <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between sticky top-0 bg-white/95 dark:bg-[#111827]/95 backdrop-blur-xl z-20">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-sky-500/10 dark:bg-cyan-400/10 rounded-xl flex items-center justify-center">
          ...
          <div className="p-6 overflow-y-auto space-y-6 flex-1 bg-gray-50/50 dark:bg-[#15151F]/30">
            {/* Metadata Card */}
            <div className="bg-white dark:bg-[#111827] p-6 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1 md:col-span-2">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full p-3 bg-gray-50 dark:bg-[#222230] border border-gray-200 dark:border-slate-800 rounded-xl text-xs font-bold text-gray-900 dark:text-white focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 resize-none"
                />
              </div>
              ...
              <div className="md:col-span-2 p-4 bg-yellow-500/5 border border-yellow-500/20 rounded-2xl flex flex-col gap-3 mt-2 select-none">
                <div className="flex items-start gap-3">
                  <input
                    ...
                    className="w-4 h-4 text-sky-600 dark:text-cyan-400 border-gray-300 dark:border-slate-800 rounded focus:ring-0 mt-0.5 cursor-pointer accent-[#00B4D8] dark:accent-[#D4AF37]"
                  />
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-[#00B4D8]/10 text-sky-600 dark:bg-[#D4AF37]/10 dark:text-cyan-400 hover:bg-[#00B4D8]/20 rounded-xl text-xs font-black transition-all flex items-center gap-1.5"
                  >
              ...
              <div className="space-y-6">
                {questions.map((q, qIdx) => (
                  <React.Fragment key={q.id}>
                    ...
                    <div
                      className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-100 dark:border-slate-800 border-r-4 border-r-indigo-500 dark:border-r-[#D4AF37] shadow-sm space-y-4 relative"
                    >
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full p-3 bg-gray-50 dark:bg-[#222230] border border-gray-100 dark:border-slate-800 rounded-xl text-xs font-bold text-gray-900 dark:text-white focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500"
                      />
                    </div>
                              ...
                              <input
                                ...
                                className={`w-full p-2.5 bg-gray-50 dark:bg-[#222230] border rounded-xl text-xs font-bold text-gray-900 dark:text-white focus:outline-none ${
                                  q.correctOptionIndex === oIdx
                                    ...
                                    : "border-gray-100 dark:border-transparent focus:border-sky-500 dark:focus:border-cyan-500"
                                }`}
                              />
                              <button
                                type="button"
                                ...
                                className={`px-3 rounded-xl text-[10px] font-black transition-all border ${
                                  q.correctOptionIndex === oIdx
                                    ...
                                    : "bg-gray-50 dark:bg-[#222230] border-gray-100 dark:border-slate-800 text-gray-500 hover:bg-gray-100"
                                }`}
                              >
                                صحيحة
                              </button>
                    ...
                    {q.type === 'essay' && (
                      <div className="space-y-1">
                        ...
                        <textarea
                          ...
                          className="w-full p-3 bg-gray-50 dark:bg-[#222230] border border-gray-100 dark:border-slate-800 rounded-xl text-xs font-bold text-gray-900 dark:text-white focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 resize-none"
                        />
                      </div>
                    )}

                    {/* Additional fields: points and explanation */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-gray-50 dark:border-slate-800/30 pt-3">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full p-2 bg-gray-50 dark:bg-[#222230] border border-gray-100 dark:border-slate-800 rounded-xl text-xs font-bold text-gray-900"
                        />
                      </div>
                      <div className="space-y-1 md:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full p-2 bg-gray-50 dark:bg-[#222230] border border-gray-100 dark:border-slate-800 rounded-xl text-xs font-medium text-gray-900 dark:text-white"
                        />
                      </div>
                    </div>
                  </div>
          ...
          {/* Footer */}
          <div className="p-6 border-t border-gray-100 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-[#111827]">
          ...
          {showBankModal && (
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" dir="rtl">
              <motion.div
                ...
                className="bg-white dark:bg-[#111827] w-full max-w-md rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]"
              >
                <div className="p-5 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between bg-gray-50/50 dark:bg-[#090D16]/30 shrink-0">
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl text-sm font-bold focus:outline-none focus:ring-2 focus:ring-emerald-500"
                        >
                      ...
                      {selectedBankId && (
                        <div className="flex p-1 bg-gray-100 dark:bg-[#090D16] rounded-xl mb-4">
                          <button
                            type="button"
                      ...
                      {importMode === 'random' && selectedBankId ? (
                        ...
                        <div className="mt-4 border border-gray-200 dark:border-slate-800 rounded-xl overflow-hidden max-h-[300px] flex flex-col">
                           <div className="p-3 bg-gray-50 dark:bg-[#090D16] border-b border-gray-200 dark:border-slate-800 flex justify-between items-center shrink-0">
                           ...
                           <div className="overflow-y-auto p-2 space-y-2">
                             {banksList.find(b => b.id === selectedBankId)?.questions?.map((q: any, idx: number) => (
                               <div 
                                 ...
                                 className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${selectedManualQuestionIds.has(q.id) ? 'border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20' : 'border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-[#1A1A24]'}`}
                               >
                                 <input
                                   type="checkbox"
                ...
                <div className="p-5 border-t border-gray-100 dark:border-slate-800 flex gap-3 shrink-0 bg-gray-50/50 dark:bg-[#090D16]/30">
                  <button
                    type="button"
