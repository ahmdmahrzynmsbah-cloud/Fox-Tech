      ...
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-gray-100 dark:border-slate-800 pb-6">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-sky-500/10 dark:bg-cyan-400/10 rounded-2xl flex items-center justify-center shrink-0">
              <BookOpen className="w-8 h-8 text-sky-600 dark:text-cyan-400" />
            </div>
            <div>
        ...
        {loading ? (
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Banks List */}
            <div className="lg:col-span-1 space-y-3 border-l-0 lg:border-l border-gray-100 dark:border-slate-800 pl-0 lg:pl-6">
              <h3 className="font-black text-lg text-gray-900 dark:text-white mb-4">قائمة بنوك الأسئلة</h3>
              {banks.length === 0 ? (
                <div className="text-center py-8 bg-gray-50 dark:bg-[#090D16] rounded-2xl border border-dashed border-gray-200 dark:border-slate-800">
                    ...
                    <button
                      ...
                      className={`w-full text-right p-4 rounded-2xl border transition-all cursor-pointer ${
                        selectedBank?.id === bank.id
                          ? 'border-sky-500 bg-[#00B4D8]/5 dark:border-cyan-500 dark:bg-[#D4AF37]/5'
                          : 'border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-[#1E1E2A]'
                      }`}
                    >
            ...
            <div className="lg:col-span-2">
              {selectedBank ? (
                <div className="bg-gray-50/50 dark:bg-[#090D16]/20 rounded-2xl p-6 border border-gray-100 dark:border-slate-800">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 border-b border-gray-200 dark:border-slate-800 pb-4">
                    <div>
                  ...
                  <div className="space-y-4 max-h-[600px] overflow-y-auto pl-2 pr-2 scroll-smooth">
                    {(!selectedBank.questions || selectedBank.questions.length === 0) ? (
                      ...
                      selectedBank.questions.map((q, idx) => (
                        <div key={q.id || idx} className="bg-white dark:bg-[#111827] rounded-2xl p-4 border border-gray-200 dark:border-slate-800 shadow-sm">
                                    ...
                                    <div 
                                      ...
                                      className={`p-2.5 rounded-xl border text-xs font-bold flex items-center gap-2 ${
                                        optIdx === ((q as any).correctOptionIndex ?? q.correctAnswer)
                                          ...
                                          : 'border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-[#090D16] text-gray-600 dark:text-gray-400'
                                      }`}
                                    >
                ...
                <div className="h-full flex flex-col items-center justify-center py-20 text-center bg-gray-50/50 dark:bg-[#090D16]/20 rounded-2xl border border-gray-100 dark:border-slate-800">
