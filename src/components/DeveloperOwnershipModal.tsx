        ...
        >
          ...
          {!isAuthenticated ? (
            ...
            <div className="p-8 md:p-12 text-center max-w-md mx-auto">
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-tr from-[#00B4D8]/20 to-[#D4AF37]/20 border border-sky-500/30 flex items-center justify-center text-sky-600">
                <Lock className="w-8 h-8" />
              </div>

              <span className="px-3.5 py-1 rounded-full text-xs font-bold bg-[#00B4D8]/10 text-sky-600 border border-sky-500/20 mb-3 inline-block">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pr-11 pl-4 py-3.5 rounded-xl bg-white/5 border border-gray-800 text-white placeholder-gray-500 focus:outline-none focus:border-sky-500 text-sm text-center font-mono tracking-widest transition-all"
                    autoFocus
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#00B4D8] to-[#0077B6] hover:from-[#0096C7] hover:to-[#005F73] text-white font-extrabold text-sm shadow-lg shadow-sky-500/20 transition-all cursor-pointer"
                >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-5 border-b border-gray-800/80">
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-tr from-[#00B4D8] to-[#D4AF37] p-[2px] shrink-0">
                    <div className="w-full h-full bg-[#0D0E15] rounded-[14px] flex items-center justify-center text-sky-600">
                ...
                <a
                  ...
                  className="px-3.5 py-2 rounded-xl bg-white/5 border border-gray-800 hover:border-sky-500 text-gray-200 hover:text-white transition-all text-xs font-bold flex items-center gap-2 shrink-0"
                >
                  <Phone className="w-4 h-4 text-sky-600" />
                  <span>هاتف الشركة:</span>
                  <span dir="ltr" className="font-mono text-sky-600 text-xs">01034859313</span>
                </a>
              </div>

              {/* Founders / Managing Directors Section */}
              <div className="bg-white/5 rounded-2xl p-4 sm:p-5 border border-gray-800/80">
                <div className="text-xs font-black text-cyan-400 mb-3 flex items-center gap-2">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-xl bg-black/40 border border-gray-800/80 flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-[#00B4D8]/10 text-sky-600 flex items-center justify-center font-black text-sm shrink-0">
                      1
                    </div>
                    <div>
                  ...
                  <div className="p-3.5 rounded-xl bg-black/40 border border-gray-800/80 flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-[#D4AF37]/10 text-cyan-400 flex items-center justify-center font-black text-sm shrink-0">
                      2
                    </div>
                    <div>
              ...
              <div className="bg-gradient-to-br from-white/5 to-white/0 rounded-2xl p-4 sm:p-5 border border-gray-800 space-y-4">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
                  ...
                  <div className="p-3 rounded-xl bg-black/30 border border-gray-800/60">
                    ...
                    <div className="font-black text-sky-600 text-sm font-mono">22 / 07 / 2026</div>
                  </div>
                    ...
                    >
                      <div className="px-4 pb-5 sm:px-5 sm:pb-5 pt-0 space-y-3 border-t border-red-500/10">
                        <p className="text-xs text-gray-300 leading-relaxed font-medium mt-3">
                          تُعتبر جميع الأكواد البرمجية، والمكونات الهندسية، والتصاميم التفاعلية الخاصة بـ <strong className="text-white font-black">منصة Fox Tech</strong> ملكية فكرية حصرية ومحفوظة لشركة <strong className="text-[#D4F800] font-black">Fox Tech Software Solutions</strong>.
                        </p>
