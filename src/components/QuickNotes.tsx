...
export default function QuickNotes({ db, userData }: QuickNotesProps) {
  ...
  return (
    <div className="space-y-8 font-sans" dir="rtl">
      {/* Title & Info Banner */}
      <div className="bg-gradient-to-r from-[#00B4D8]/10 via-[#0077B6]/5 to-transparent dark:from-[#D4AF37]/10 dark:via-[#B8860B]/5 dark:to-transparent p-6 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm space-y-5 lg:sticky lg:top-6">
          ...
          <form onSubmit={handleSaveNote} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-gray-50 dark:bg-[#15151F] border border-gray-200 dark:border-slate-800 rounded-2xl p-4 text-sm font-bold text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-500 dark:focus:ring-cyan-400 placeholder-gray-400 dark:placeholder-gray-600 transition-all leading-relaxed resize-none"
              />
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-cyan-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 hover:opacity-95 text-white py-3.5 px-4 rounded-2xl text-xs font-black flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm disabled:opacity-40 disabled:cursor-not-allowed"
              >
                {saving ? (
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white dark:bg-[#111827] p-4 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-[#15151F] border border-gray-200 dark:border-slate-800 rounded-2xl pr-11 pl-4 py-3 text-xs font-bold text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-sky-500 dark:focus:ring-cyan-400 transition-all"
                />
              </div>
            ...
            <div className="flex items-center justify-between pt-1 text-[11px] font-black text-gray-400 dark:text-gray-500">
              <span className="flex items-center gap-1.5">
                <ListFilter className="w-3.5 h-3.5 text-sky-600 dark:text-cyan-400" />
          ...
          <div className="space-y-4">
            {loading ? (
              <div className="p-16 text-center bg-white dark:bg-[#111827] rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col items-center justify-center gap-3">
                  ...
                  {filteredNotes.map((note) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-white dark:bg-[#111827] p-5 rounded-2xl border border-gray-100 dark:border-slate-800 hover:shadow-md transition-all flex flex-col justify-between space-y-4 group relative overflow-hidden"
                      >
                        ...
                        {/* Actions footer */}
                        <div className="flex items-center justify-end gap-2 pt-3 border-t border-gray-50 dark:border-slate-800/50">
                          <button
                            type="button"
