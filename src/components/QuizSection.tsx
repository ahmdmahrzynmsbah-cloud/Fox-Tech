...
export default function QuizSection({ courseId, lessonId, lessonTitle, userData, isTeacher }: QuizSectionProps) {
  ...
  if (isTeacher) {
    return (
      <div className="space-y-6 text-right" dir="rtl">
        {/* Toggle between tabs */}
        <div className="flex justify-between items-center bg-gray-50 dark:bg-[#090D16] p-1.5 rounded-xl border border-gray-200 dark:border-slate-800">
        ...
        {activeTeacherTab === 'edit' && (
          <div className="bg-gray-50 dark:bg-[#222230] p-5 sm:p-6 rounded-2xl border border-gray-200 dark:border-slate-800 space-y-6">
            <div className="flex justify-between items-center border-b border-gray-200/60 dark:border-slate-800/60 pb-4">
              <div>
              ...
              {!isEditing && quiz ? (
                <button
                  ...
                  className="bg-sky-600 dark:bg-cyan-500 text-white text-xs px-5 py-2.5 rounded-xl font-bold flex items-center gap-1.5 hover:opacity-90"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full text-xs font-bold p-3 bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl focus:border-sky-500 dark:focus:border-cyan-500 outline-none"
                />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-xl px-3">
            ...
            {(isEditing || !quiz) && (
              <div className="bg-yellow-500/5 dark:bg-yellow-500/10 border border-yellow-500/20 dark:border-yellow-500/30 rounded-2xl p-4 flex items-center gap-3">
                <input
                  ...
                  className="w-4 h-4 text-sky-600 dark:text-cyan-400 border-gray-300 dark:border-slate-800 rounded focus:ring-0 cursor-pointer accent-[#00B4D8] dark:accent-[#D4AF37]"
                />
            ...
            <div className="space-y-4 pt-4">
              <div className="flex justify-between items-center">
                <h4 className="text-sm font-black text-gray-900 dark:text-white flex items-center gap-1.5">
                  <List className="w-4 h-4 text-sky-600 dark:text-cyan-400" />
                ...
                {(isEditing || !quiz) && (
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="text-[10px] sm:text-xs font-black text-sky-600 dark:text-cyan-400 bg-sky-500/10 dark:bg-cyan-400/10 px-3 py-2 rounded-xl flex items-center gap-1.5 hover:opacity-80 transition-all"
                    >
              ...
              <div className="space-y-5">
                {questions.map((q, qIdx) => (
                  <div 
                    key={q.id} 
                    className="p-5 bg-white dark:bg-[#1C1C28] rounded-xl border border-gray-100 dark:border-slate-800 space-y-4 shadow-sm relative"
                  >
                    {/* Header of question */}
                    <div className="flex justify-between items-center">
                      <span className="text-xs font-black bg-gray-100 dark:bg-[#2D2D3D] px-3 py-1.5 rounded-lg text-sky-600 dark:text-cyan-400">
                        السؤال {qIdx + 1}
                      </span>
                      {(isEditing || !quiz) && (
                        <button
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full text-xs font-bold p-3 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl focus:border-sky-500 dark:focus:border-cyan-500 outline-none resize-none"
                      />
                    </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {q.options.map((opt, optIdx) => (
                            <div key={optIdx} className="flex items-center gap-2 bg-gray-50 dark:bg-[#090D16] rounded-xl p-2 border border-gray-200 dark:border-slate-800">
                              <button
                                type="button"
                                disabled={!isEditing && !!quiz}
                                ...
                                className={`w-6 h-6 rounded-full shrink-0 flex items-center justify-center font-bold text-xs border ${
                                  q.correctOptionIndex === optIdx
                                    ...
                                    : 'bg-white dark:bg-[#111827] text-gray-400 border-gray-300 dark:border-gray-600 hover:border-green-500'
                                }`}
                          ...
                          <button
                            ...
                            className={`flex-1 py-3 rounded-xl font-bold transition-all border text-sm ${
                              q.correctOptionIndex === 0
                                ...
                                : "bg-gray-50 dark:bg-[#222230] border-gray-200 dark:border-slate-800 text-gray-500"
                            }`}
                          >
                            صح
                          </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="md:col-span-3 space-y-1.5">
                        ...
                        <input
                          ...
                          className="w-full text-xs font-medium p-3 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl focus:border-sky-500 dark:focus:border-cyan-500 outline-none"
                        />
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className="w-full text-xs font-bold p-3 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl focus:border-sky-500 dark:focus:border-cyan-500 outline-none"
                        />
                      </div>
                    </div>
                  </div>
            ...
            {(isEditing || !quiz) && (
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-200/50 dark:border-gray-800">
                <button
                  onClick={handleSaveQuizByTeacher}
                  disabled={savingQuiz}
                  className="bg-gradient-to-tr from-sky-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 text-white text-sm px-8 py-3.5 rounded-2xl font-black shadow-lg shadow-sky-500/20 dark:shadow-cyan-500/20 flex items-center gap-2 hover:opacity-90"
                >
          ...
          <div className="bg-gray-50 dark:bg-[#222230] p-5 sm:p-6 rounded-2xl border border-gray-200 dark:border-slate-800 space-y-6">
            ...
            {selectedStudentAnswers ? (
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center bg-white dark:bg-[#1C1C28] p-4 rounded-xl border border-gray-100 dark:border-slate-800">
                  <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-left font-sans">
                      <div className="text-lg font-black text-sky-600 dark:text-cyan-400">{selectedStudentAnswers.score}%</div>
                ...
                <div className="space-y-4">
                  {quiz?.questions.map((q, idx) => {
                    ...
                    return (
                      <div key={q.id} className="p-4 bg-white dark:bg-[#111827] border border-gray-100 dark:border-slate-800 rounded-xl space-y-3">
                        ...
                        {(!q.type || q.type === 'multiple_choice' || q.type === 'true_false') && (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2">
                            {q.options.map((opt, optIdx) => {
                              ...
                              let btnStyle = 'bg-gray-50 dark:bg-[#090D16] text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-slate-800';
                        ...
                        {q.type === 'essay' && (
                          <div className="pt-2 space-y-3">
                            <div className="bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 p-3 rounded-xl">
              ...
              <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-[#111827]">
                    ...
                    {allSubmissions.length === 0 ? (
                      ...
                      allSubmissions.map((sub) => (
                        <tr key={sub.id} className="hover:bg-gray-50 dark:hover:bg-[#222230]">
                          ...
                          <td className="p-4 font-sans text-sm text-sky-600 dark:text-cyan-400">{sub.score}%</td>
                          ...
                          <td className="p-4 text-center">
                            <button
                              ...
                              className="text-[10px] font-black text-sky-600 dark:text-cyan-400 bg-sky-500/10 dark:bg-cyan-400/10 px-3 py-1.5 rounded-lg hover:opacity-80 transition-all"
                            >
  ...
  if (!quiz) {
    return (
      <div className="bg-white dark:bg-[#111827] rounded-2xl p-6 border border-gray-100 dark:border-slate-800 text-center py-12" dir="rtl">
      ...
      <AnimatePresence mode="wait">
        ...
        {!quizStarted && !reviewMode && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="bg-white dark:bg-[#111827] rounded-2xl p-5 sm:p-6 border border-gray-200 dark:border-slate-800 space-y-6"
          >
            {/* Header info */}
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-100 dark:border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-1 bg-sky-500/10 dark:bg-cyan-400/10 text-sky-600 dark:text-cyan-400 rounded-full text-[10px] font-black">
                    اختبار تفاعلي سريع
                  </span>
                  {quiz.timeLimit ? (
              ...
              <button
                ...
                className="bg-gradient-to-tr from-sky-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 text-white px-8 py-3.5 rounded-2xl font-black text-sm shadow-lg shadow-sky-500/20 dark:shadow-cyan-500/20 hover:opacity-90 transition-all shrink-0 w-full sm:w-auto text-center cursor-pointer"
              >
            ...
            {submission ? (
              <div className="p-5 rounded-2xl bg-gray-50 dark:bg-[#222230] border border-gray-100 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                <div className="p-4 rounded-xl bg-gray-50/50 dark:bg-[#222230]/50 border border-gray-100 dark:border-slate-800/50 space-y-1">
                  <HelpCircle className="w-6 h-6 mx-auto text-sky-600 dark:text-cyan-400" />
                ...
                <div className="p-4 rounded-xl bg-gray-50/50 dark:bg-[#222230]/50 border border-gray-100 dark:border-slate-800/50 space-y-1">
                  <Award className="w-6 h-6 mx-auto text-sky-600 dark:text-cyan-400" />
                ...
                <div className="p-4 rounded-xl bg-gray-50/50 dark:bg-[#222230]/50 border border-gray-100 dark:border-slate-800/50 space-y-1">
                  <BookOpen className="w-6 h-6 mx-auto text-sky-600 dark:text-cyan-400" />
        ...
        {quizStarted && (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-between items-center border-b border-gray-100 dark:border-slate-800/60 pb-3">
              <div className="space-y-0.5 text-right w-full sm:w-auto">
                <span className="text-[10px] text-sky-600 dark:text-cyan-400 font-black">جاري حل الاختبار الآن</span>
            ...
            <div className="space-y-4 mb-2 mt-4">
              <div className="space-y-1.5">
                ...
                <div className="w-full h-2 bg-gray-100 dark:bg-[#090D16] rounded-full overflow-hidden border border-gray-200/50 dark:border-gray-800">
                  <div 
            ...
            {/* Question card */}
            <div className="space-y-4">
              <div className="p-5 sm:p-6 bg-gray-50 dark:bg-[#222230] rounded-2xl border border-gray-100 dark:border-slate-800">
                <span className="text-[10px] bg-sky-500/10 dark:bg-cyan-400/10 text-sky-600 dark:text-cyan-400 px-2 py-1 rounded-md font-bold mb-3 inline-block">
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-xl text-xs font-black text-right border transition-all flex items-center justify-between gap-3 group relative overflow-hidden ${
                        isSelected
                          ? 'bg-sky-500/10 dark:bg-cyan-400/10 border-sky-500 dark:border-cyan-400 text-sky-600 dark:text-cyan-400 shadow-md shadow-sky-500/5 dark:shadow-cyan-500/5'
                          : 'bg-gray-50 dark:bg-[#222230] border-gray-200/80 dark:border-slate-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#2d2d3d] hover:border-gray-300'
                      }`}
                    >
                      <span className="flex items-center gap-3">
                        <span className={`w-6 h-6 rounded-lg font-sans font-black text-xs flex items-center justify-center shrink-0 transition-all ${
                          isSelected
                            ...
                            : 'bg-gray-200 dark:bg-[#2D2D3D] text-gray-600 dark:text-gray-400 group-hover:bg-[#00B4D8]/20 dark:group-hover:bg-[#D4AF37]/20 group-hover:text-sky-600 dark:group-hover:text-cyan-400'
                        }`}>
                          {optionMarkers[optIdx]}
                        </span>
                        <span className="leading-relaxed">{opt}</span>
                      </span>
                      {isSelected && <Check className="w-4 h-4 text-sky-600 dark:text-cyan-400 shrink-0" />}
                    </button>
                  );
                })}
              </div>
            ...
            {/* Back / Next actions */}
            <div className="flex justify-between items-center border-t border-gray-100 dark:border-slate-800/50 pt-4">
              <button
              ...
              {currentQuestionIdx === quiz.questions.length - 1 ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs font-black text-sky-600 dark:text-cyan-400 hover:opacity-85 py-2 px-4 rounded-xl bg-sky-500/10 dark:bg-cyan-400/10"
                >
                  السؤال التالي
        ...
        {showInfractionWarning && infractions < 3 && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white dark:bg-[#0D121F] rounded-3xl p-6 max-w-md w-full shadow-2xl border border-red-500/30 space-y-6 text-center z-10"
            >
        ...
        {reviewMode && submission && (
          ...
          >
            {/* Results Header Card */}
            <div className="bg-white dark:bg-[#111827] rounded-2xl p-5 sm:p-6 border border-gray-200 dark:border-slate-800 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-around gap-6 py-3">
                ...
                <div className="grid grid-cols-2 gap-4 flex-1 w-full sm:w-auto">
                  ...
                  <div className="p-3 bg-gray-50 dark:bg-[#222230] rounded-xl text-center">
                    ...
                    <span className="text-base font-black text-sky-600 dark:text-cyan-400 font-sans">+{submission.passed ? submission.score : 0} نجمة</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center bg-sky-500/5 dark:bg-cyan-400/5 p-3.5 rounded-xl border border-sky-500/10 dark:border-cyan-400/10 text-xs">
                <span className="text-gray-600 dark:text-gray-300 flex items-center gap-1.5 font-medium">
                  <AlertCircle className="w-4 h-4 text-sky-600 dark:text-cyan-400" />
                  يمكنك مراجعة كافة الأسئلة أدناه والاطلاع على التفسير والحل لكل سؤال.
                </span>
                <button
                  onClick={handleStartQuiz}
                  className="bg-sky-600 dark:bg-cyan-500 text-white px-4 py-2 rounded-xl font-black text-[10px] hover:opacity-90"
                >
        ...
        {showResultModal && submission && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-white dark:bg-[#111827] rounded-3xl border border-gray-100 dark:border-slate-800 shadow-2xl overflow-hidden text-right flex flex-col max-h-[90vh]"
            >
              {/* Header Banner */}
                ...
                <div className="relative z-10 flex items-start justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-white/90 leading-relaxed max-w-md">
                      {submission.passed
                        ? 'رائع جداً! لقد أظهرت فهماً ممتازاً واستحقيت نقاط الخبرة والتميز المضافة لرصيدك.'
              ...
              <div className="p-6 md:p-8 space-y-6 overflow-y-auto flex-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {/* Score Gauge */}
                  <div className="p-4 bg-gray-50 dark:bg-[#222230] rounded-2xl border border-gray-100 dark:border-slate-800/50 flex flex-col items-center justify-center text-center">
                  ...
                  {/* Points Earned */}
                  <div className="p-4 bg-gray-50 dark:bg-[#222230] rounded-2xl border border-gray-100 dark:border-slate-800/50 flex flex-col items-center justify-center text-center">
                    <span className="text-[10px] text-gray-400 dark:text-gray-500 block font-black mb-1">نقاط التميز المكتسبة</span>
                ...
                <div className="space-y-4">
                  <h4 className="text-xs font-black text-gray-900 dark:text-white flex items-center gap-1.5 pb-2 border-b border-gray-100 dark:border-slate-800">
                      ...
                      <div className="space-y-4">
                        {mistakes.map((q, mIdx) => {
                          ...
                          return (
                            <div 
                              key={q.id} 
                              className="p-4 bg-gray-50/50 dark:bg-[#1C1C28]/50 rounded-2xl border border-gray-100 dark:border-slate-800 space-y-3"
                            >
                              <div className="flex justify-between items-center">
              ...
              {/* Footer Actions */}
              <div className="p-4 bg-gray-50 dark:bg-[#151520] border-t border-gray-100 dark:border-slate-800 flex justify-between items-center shrink-0">
        ...
        {showSubmitConfirmModal && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-md shadow-2xl p-6 border border-gray-100 dark:border-slate-800 text-right"
              dir="rtl"
            >
