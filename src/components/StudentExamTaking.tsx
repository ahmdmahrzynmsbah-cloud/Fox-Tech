    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md" dir="rtl">
        <motion.div
          ...
          className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] text-right border border-gray-100 dark:border-slate-800"
        >
          {/* RESULTS VIEW */}
          {showResults && submissionResult ? (
            <div className="p-8 flex flex-col items-center justify-center text-center space-y-6 flex-1 overflow-y-auto">
              ...
              {/* Score Dashboard */}
              <div className="grid grid-cols-2 gap-4 w-full max-w-md bg-gray-50 dark:bg-[#13131C] p-6 rounded-3xl border border-gray-100 dark:border-slate-800">
                ...
                <div className="text-center space-y-1 border-r border-gray-200 dark:border-slate-800/50 pr-4">
            ...
            <div className="p-8 flex flex-col flex-1 overflow-hidden">
              <div className="space-y-6 overflow-y-auto flex-1 pr-1">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 bg-gray-50 dark:bg-[#13131C] rounded-2xl border border-gray-100 dark:border-slate-800 flex items-center gap-3">
                  ...
                  {exam.description && (
                    <div className="bg-gray-50 dark:bg-[#1D1D28] p-4 rounded-2xl text-xs text-gray-500 leading-relaxed font-bold border border-gray-100 dark:border-slate-800/50">
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-100 dark:border-slate-800 mt-6 shrink-0">
                <button
                  onClick={onClose}
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
              {/* Active Header */}
              <div className="p-6 border-b border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-[#13131C] flex flex-col sm:flex-row gap-3 items-center justify-between">
                <div>
                ...
                <div className={`px-4 py-2 rounded-2xl flex items-center gap-2 border font-black text-sm select-none w-full sm:w-auto justify-center ${
                  timeLeft !== null && timeLeft < 120 
                    ...
                    : "bg-[#00B4D8]/10 text-sky-700 dark:bg-[#D4AF37]/10 dark:text-cyan-400 border-transparent"
                }`}>
                        ...
                        return (
                          <button
                            ...
                            className={`w-full p-4 rounded-2xl text-right border text-xs font-black transition-all flex items-center justify-between ${
                              isSelected
                                ? "bg-gradient-to-l from-[#00B4D8]/10 to-transparent border-sky-500 dark:from-[#D4AF37]/10 dark:to-transparent dark:border-cyan-500 shadow-sm scale-[1.01]"
                                : "bg-white dark:bg-[#111827] border-gray-100 dark:border-slate-800/50 hover:bg-gray-50 dark:hover:bg-[#20202d]"
                            }`}
                          >
                            <span className="flex items-center gap-3">
                              ...
                              <span className={isSelected ? "text-sky-600 dark:text-cyan-400" : "text-gray-700 dark:text-gray-300"}>
                                {option}
                              </span>
                            </span>
                            {isSelected && (
              ...
              <div className="p-6 border-t border-gray-100 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-[#111827]">
                ...
                {currentIdx < questionsList.length - 1 ? (
                  <button
                    onClick={() => setCurrentIdx((p) => p + 1)}
                    className="px-5 py-2.5 bg-sky-600 dark:bg-cyan-500 text-white hover:opacity-95 rounded-xl text-xs font-bold transition-all flex items-center gap-1 shadow-sm"
                  >
                    التالي
