      ...
      <html dir="rtl" lang="ar">
        ...
        <body>
          ...
          <div class="invoice-box">
            <div class="header">
              <div>
                <div class="logo">Fox Tech</div>
                <div style="font-size: 12px; color: #6b7280; margin-top: 4px;">أكاديمية فوكس تك التعليمية</div>
              </div>
            ...
            <div class="footer">
              <p>شكراً لشرائك من متجر Fox Tech.</p>
    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm">
        ...
        {loading ? (
          ...
          <div className="py-20 flex flex-col justify-center items-center gap-4 bg-gray-50 dark:bg-[#090D16] rounded-2xl mt-6 border border-dashed border-gray-200 dark:border-slate-800">
            <div className="w-20 h-20 bg-white dark:bg-[#111827] rounded-full flex items-center justify-center shadow-sm">
          ...
          <div className="mt-6 space-y-3">
            {orders.map(order => {
              ...
              return (
                <div key={order.id} className="bg-white dark:bg-[#0D121F] border border-gray-150 dark:border-slate-800/50 rounded-2xl p-3.5 hover:bg-gray-50/50 dark:hover:bg-[#15151F]/30 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative pl-4 pr-5 overflow-hidden group">
                  ...
                  <div className="flex items-center gap-4 min-w-0 flex-1">
                    <div className="w-12 h-12 bg-gray-100 dark:bg-[#111827] rounded-xl overflow-hidden shrink-0 flex items-center justify-center relative border border-gray-100 dark:border-slate-800">
                      {item?.imageUrl ? (
                  ...
                  <div className="flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-6 justify-between sm:justify-end">
                    ...
                    <div className="text-right sm:text-left">
                      ...
                      <div className="flex items-center sm:justify-end gap-1 text-base font-black text-sky-600 dark:text-cyan-400 font-mono">
                        {order.amount} 
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto px-4 py-2 bg-gray-50 hover:bg-gray-100 dark:bg-[#111827] dark:hover:bg-[#2D2D3D] text-gray-700 dark:text-gray-300 rounded-xl text-xs font-black flex items-center justify-center gap-1.5 border border-gray-200 dark:border-slate-800 transition-colors cursor-pointer"
                    >
