...
export default function ComprehensiveAnalytics({ userData, linkedStudent }: ComprehensiveAnalyticsProps) {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        <div className="w-12 h-12 border-4 border-sky-500 dark:border-cyan-400 border-t-transparent rounded-full animate-spin"></div>
  ...
  if (role === 'admin') {
    ...
    return (
      <div className="space-y-8 animate-in fade-in duration-300">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-[#111827] p-5 rounded-2xl border border-gray-200 dark:border-slate-800 print:hidden">
          <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-950/20 dark:to-blue-900/10 p-6 rounded-2xl border border-blue-200/50 dark:border-slate-200 dark:border-white/10 flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Main Line Chart */}
          <div className="lg:col-span-8 bg-gray-50/50 dark:bg-[#0D121F]/50 p-6 rounded-2xl border border-gray-200 dark:border-slate-800 space-y-4">
          ...
          <div className="lg:col-span-4 bg-gray-50/50 dark:bg-[#0D121F]/50 p-6 rounded-2xl border border-gray-200 dark:border-slate-800 flex flex-col justify-between">
            <div>
        ...
        <div className="bg-gray-50/50 dark:bg-[#0D121F]/50 p-6 rounded-2xl border border-gray-200 dark:border-slate-800">
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-150 dark:border-slate-800 bg-white dark:bg-[#090D16]">
            <table className="w-full text-right text-xs">
              <thead>
                <tr className="bg-gray-50 dark:bg-[#0D121F] border-b border-gray-150 dark:border-slate-800 text-gray-500 dark:text-gray-400 font-extrabold text-sm">
                  ...
                  <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-[#1A1A24]/30 transition-colors">
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-sky-500/10 dark:bg-cyan-400/10 text-sky-600 dark:text-cyan-400 flex items-center justify-center font-black text-base border border-sky-500/10 dark:border-cyan-400/10">
                ...
                <div className="w-full md:w-80 space-y-4 md:border-l md:border-slate-150 md:pl-6 print:hidden">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold outline-none focus:border-purple-500 dark:text-white" 
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      rows={3}
                      className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold outline-none focus:border-purple-500 dark:text-white resize-none" 
                    />
                  </div>
                ...
                <div className="flex-1 bg-white text-slate-900 border border-slate-200 rounded-2xl p-6 md:p-8 flex flex-col justify-between shadow-sm print:border-none print:shadow-none print:p-0 printable-area">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-right">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2 justify-center sm:justify-start mb-2">
                          ...
                          <span className="text-lg font-black text-slate-800 tracking-tight">Fox Tech</span>
                        </div>
                  ...
                  <div className="pt-6 border-t border-slate-200 text-center space-y-4">
                    <p className="text-[8px] text-slate-400 font-bold leading-loose">
                      صدر هذا التقرير إلكترونياً عن طريق الإدارة المركزية لمنصة Fox Tech التدريبية المعتمدة.<br/>
    ...
    return (
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gray-50 dark:bg-[#090D16] p-6 rounded-2xl border border-gray-200 dark:border-slate-800 flex items-center gap-4 h-full">
        ...
        {/* Courses Table */}
        <div className="bg-gray-50 dark:bg-[#090D16] p-6 rounded-2xl border border-gray-200 dark:border-slate-800">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-right">
              <thead>
                <tr className="border-b border-gray-200 dark:border-slate-800 text-gray-500 dark:text-gray-400 text-xs font-black">
          ...
          <div className="space-y-4">
            {teacherStats.reviews.length > 0 ? (
              teacherStats.reviews.map(review => {
                ...
                return (
                  <div key={review.id} className="p-4 rounded-xl bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 space-y-3">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-sky-500/10 dark:bg-cyan-400/10 text-sky-600 dark:text-cyan-400 rounded-full flex items-center justify-center text-sm font-black">
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="bg-gradient-to-br from-[#00B4D8]/5 to-purple-500/5 p-6 rounded-2xl border border-gray-150 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <button
          onClick={() => setPrintModalOpen(true)}
          className="flex items-center gap-2 bg-[#00B4D8] hover:bg-[#0096B4] dark:bg-[#D4AF37] dark:hover:bg-[#B8860B] text-white dark:text-[#0D0D12] font-black text-xs px-5 py-3 rounded-xl transition-all shadow-md shadow-sky-500/20 dark:shadow-cyan-500/10"
        >
          <Printer className="w-4 h-4" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-gray-50 dark:bg-[#090D16] p-6 rounded-2xl border border-gray-200 dark:border-slate-800 flex items-center gap-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-gray-50/50 dark:bg-[#0D121F]/50 p-6 rounded-2xl border border-gray-200 dark:border-slate-800 space-y-4">
          ...
          {studentStats.submissions.length > 0 ? (
            <div className="overflow-hidden rounded-xl border border-gray-150 dark:border-slate-800 bg-white dark:bg-[#090D16]">
              <table className="w-full text-right text-xs">
                <thead>
                  <tr className="bg-gray-50 dark:bg-[#0D121F] border-b border-gray-150 dark:border-slate-800 text-gray-500 dark:text-gray-400 font-extrabold text-xs">
            ...
            <div className="bg-white dark:bg-[#090D16] rounded-xl border border-dashed border-gray-200 dark:border-slate-800 p-10 text-center font-bold text-gray-400 space-y-2">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-gray-50/50 dark:bg-[#0D121F]/50 p-6 rounded-2xl border border-gray-200 dark:border-slate-800">
            ...
            <div className="grid grid-cols-2 gap-3">
              {studentStats.badges.map((badge, index) => (
                <div key={index} className="bg-white dark:bg-[#090D16] p-3 rounded-xl border border-gray-150 dark:border-slate-800 text-center space-y-2 hover:scale-105 transition-all">
          ...
          <div className="bg-gray-50/50 dark:bg-[#0D121F]/50 p-6 rounded-2xl border border-gray-200 dark:border-slate-800 space-y-3">
            <h3 className="text-base font-black text-gray-900 dark:text-white flex items-center gap-1.5">
                    ...
                    <button 
                      ...
                      className={`py-2 px-1 rounded-xl text-[10px] font-black border transition-all ${
                        printDateRange === 'all' 
                          ...
                          : 'bg-gray-50 border-gray-200 text-gray-500 dark:bg-[#090D16] dark:border-slate-800'
                      }`}
                    >
                      شامل
                    </button>
              ...
              <div className="flex-1 bg-white text-slate-900 border border-slate-200 rounded-2xl p-6 md:p-8 flex flex-col justify-between shadow-sm print:border-none print:shadow-none print:p-0 printable-area">
                ...
                <div className="border-t border-slate-200 pt-6 mt-6">
                  ...
                  <div className="text-center text-[9px] text-slate-400 font-bold border-t border-slate-100 pt-3">
                    صدر هذا التقرير إلكترونياً عن طريق بوابة المتابعين والمتدربين لمنصة Fox Tech المعتمدة.
                  </div>
                </div>
