...
export default function FinancesManager({ userData }: FinancesManagerProps) {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center py-20 bg-white dark:bg-[#111827] rounded-3xl border border-gray-200 dark:border-slate-800">
  ...
  return (
    <div className="space-y-8 print:w-full print:block" dir="rtl">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {isAdmin ? (
          <>
            ...
            <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-150 dark:border-slate-800 shadow-sm relative overflow-hidden flex items-center gap-5">
          ...
          <>
            ...
            <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-150 dark:border-slate-800 shadow-sm relative overflow-hidden flex items-center gap-5">
              <div className="w-14 h-14 rounded-2xl bg-blue-50 dark:bg-blue-950/20 text-sky-600 flex items-center justify-center shrink-0">
                <Users className="w-7 h-7" />
              </div>
              <div className="flex-1">
                <span className="text-xs font-bold text-gray-400 dark:text-gray-500 block mb-1">إجمالي الطلاب المشتركين</span>
                <h3 className="text-2xl font-black text-sky-600 font-mono">
      ...
      {/* 1.5 ADMIN CHARTS */}
      {isAdmin && (
        <section className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-150 dark:border-slate-800 shadow-sm">
      ...
      {isAdmin && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            {/* Add Expense Card */}
            <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm shrink-0">
              ...
              <form onSubmit={handleAddExpense} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-rose-500 dark:text-white font-bold text-sm font-mono transition-colors"
                      required
                    />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-rose-500 dark:text-white font-bold text-sm transition-colors"
                        required
                      />
                    </div>
                  </div>
                ...
                {/* Category Section */}
                <div className="p-3 rounded-xl border border-gray-100 dark:border-slate-800 bg-gray-50/80 dark:bg-[#0D121F] space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-white dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 outline-none focus:border-rose-500 text-xs font-bold text-gray-800 dark:text-gray-200 transition-colors"
                  >
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-white dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-lg px-3 py-2 outline-none focus:border-rose-500 dark:text-white text-[10px] font-medium transition-colors"
                    />
                    <button
                      type="button"
                      onClick={() => {
            ...
            {/* Expenses List Card */}
            <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col flex-1 overflow-hidden print:overflow-visible print:min-h-0 print:h-auto min-h-[350px]">
              ...
              <div className="flex-1 overflow-y-auto print:overflow-visible scrollbar-thin space-y-3 pl-1">
                {expenses.length === 0 ? (
                  ...
                  expenses.map((exp) => (
                    <div key={exp.id} className="bg-gray-50/50 dark:bg-[#0D121F]/30 p-3.5 rounded-2xl border border-gray-150 dark:border-slate-800 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="p-1.5 text-gray-400 hover:text-rose-500 bg-white dark:bg-[#111827] rounded-lg border border-gray-100 dark:border-slate-800 shadow-sm transition-all"
                          title="حذف المصروف"
                        >
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col flex-1 overflow-hidden print:overflow-visible print:min-h-0 print:h-auto min-h-[500px]">
              <div className="flex justify-between items-center mb-6 shrink-0">
                ...
                <div className="bg-[#00B4D8]/10 text-sky-600 border border-sky-500/20 px-3 py-1.5 rounded-xl text-xs font-bold">
                    ...
                    return (
                      <div 
                        ...
                        className={`border rounded-2xl transition-all ${
                          isExpanded 
                            ? 'bg-gray-50/50 dark:bg-[#0D121F]/30 border-sky-500/30 dark:border-cyan-400/30 shadow-sm' 
                            : 'bg-white dark:bg-[#111827] border-gray-150 dark:border-slate-800 hover:border-sky-500/20 dark:hover:border-cyan-400/20'
                        }`}
                      >
                        ...
                        {isExpanded && (
                          <div className="border-t border-gray-200 dark:border-slate-800 p-4 bg-white dark:bg-[#161622] rounded-b-2xl animate-in slide-in-from-top-2 duration-200">
                            ...
                            {courses.filter(c => c.teacherId === teacher.id).length === 0 ? (
                              ...
                              <div className="overflow-hidden border border-gray-100 dark:border-slate-800 rounded-xl">
                                <table className="w-full text-right border-collapse text-xs">
                                  <thead>
                                    <tr className="bg-gray-50 dark:bg-[#0D121F] border-b border-gray-100 dark:border-slate-800 text-gray-500 font-bold">
      ...
      {isTeacher && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            <div className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col flex-1 overflow-hidden print:overflow-visible print:min-h-0 print:h-auto min-h-[450px]">
              ...
              <div className="mt-6 flex-1 overflow-y-auto print:overflow-visible scrollbar-thin">
                {myCourses.length === 0 ? (
                  ...
                  <div className="overflow-hidden border border-gray-150 dark:border-slate-800 rounded-2xl">
                    <table className="w-full text-right border-collapse text-xs md:text-sm">
                      <thead>
                        <tr className="bg-gray-50 dark:bg-[#0D121F] border-b border-gray-150 dark:border-slate-800 text-gray-500 dark:text-gray-400 font-black">
                          ...
                          return (
                            <tr key={course.id} className="hover:bg-gray-50/50 dark:hover:bg-[#1E1E2D]/50 transition-colors">
                              ...
                              <td className="p-4 text-center">
                                <span className="bg-blue-50 dark:bg-blue-950/30 text-sky-600 dark:text-blue-400 px-2.5 py-1 rounded-xl text-xs font-black">
                                  {subs} طالب
                                </span>
                              </td>
              ...
              <div className="flex-1 overflow-y-auto print:overflow-visible scrollbar-thin space-y-3.5 pl-1">
                {myRecentSubscribedPayments.length === 0 ? (
                  ...
                  myRecentSubscribedPayments.map((p) => (
                    <div key={p.id} className="bg-gray-50/50 dark:bg-[#0D121F]/30 p-3.5 rounded-2xl border border-gray-150 dark:border-slate-800 flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500">الكورس: <span className="text-sky-600 dark:text-cyan-400">{p.courseTitle}</span></p>
        ...
        {confirmModal.isOpen && (
          <div className="fixed inset-0 bg-black/60 z-[110] flex items-center justify-center p-4 backdrop-blur-sm">
            <motion.div
              ...
              className="bg-white dark:bg-[#111827] rounded-3xl p-6 max-w-md w-full border border-gray-200 dark:border-slate-800 shadow-2xl"
            >
      ...
      {statementModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-y-auto print:static print:h-auto print:block print:p-0 print:z-auto">
          ...
          <div className="relative bg-white dark:bg-[#111827] rounded-3xl w-full max-w-5xl p-6 md:p-8 border border-gray-200 dark:border-slate-800 shadow-2xl z-10 max-h-[90vh] overflow-y-auto flex flex-col md:flex-row gap-6 print:w-full print:max-w-none print:max-h-none print:h-auto print:overflow-visible print:bg-white print:text-black print:p-0 print:border-none print:shadow-none print:block">
            ...
            {/* Document Preview */}
            <div className="flex-1 bg-white dark:bg-[#090D16] text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-slate-800 rounded-2xl p-6 md:p-8 flex flex-col shadow-sm print:border-none print:shadow-none print:p-0 min-h-[500px] print:bg-white print:text-black">
              {!statementGenerated ? (
                ...
                <div className="space-y-6">
                  {/* Header */}
                  <div className="flex justify-between items-start border-b border-gray-200 dark:border-slate-800 print:border-gray-200 pb-6">
                    <div>
                    ...
                    <div className="text-left">
                      <h3 className="font-black text-lg text-sky-600">Fox Tech</h3>
                    ...
                    return (
                      <>
                        ...
                        <div className="space-y-8">
                          <div>
                            <div className="flex items-center justify-between border-b border-gray-200 dark:border-slate-800 print:border-gray-200 pb-2 mb-4">
                              ...
                              <span className="text-xs font-bold text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-[#111827] px-2 py-1 rounded-lg print:bg-gray-100 print:text-gray-500">{filteredTeacherPayments.length} عملية</span>
                            </div>
                            
                            {filteredTeacherPayments.length > 0 ? (
                              <div className="overflow-hidden border border-gray-200 dark:border-slate-800 rounded-xl print:border-gray-200">
                                <table className="w-full text-right text-xs">
                                  <thead className="bg-gray-50 dark:bg-[#111827] text-gray-600 dark:text-gray-300 border-b border-gray-200 dark:border-slate-800 print:bg-gray-50 print:border-gray-200">
                                    <tr>
                                  ...
                                  <tfoot className="bg-gray-50 dark:bg-[#0D121F] border-t border-gray-200 dark:border-slate-800 print:bg-gray-50 print:border-gray-200">
                                    <tr>
                              ...
                              <div className="bg-gray-50 dark:bg-[#0D121F] rounded-xl p-8 text-center border border-gray-100 dark:border-slate-800 print:bg-gray-50 print:border-gray-100">
                          ...
                          {isAdmin && (
                            <div>
                              <div className="flex items-center justify-between border-b border-gray-200 dark:border-slate-800 print:border-gray-200 pb-2 mb-4">
                                ...
                                <span className="text-xs font-bold text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-[#111827] px-2 py-1 rounded-lg print:bg-gray-100 print:text-gray-500">{filteredExpenses.length} عملية</span>
                              </div>
                                    ...
                                    <tbody className="divide-y divide-gray-100 dark:divide-[#2D2D3D] print:divide-gray-100">
                                      {filteredExpenses.map((e, index) => (
                                        <tr key={e.id} className="hover:bg-gray-50/50 dark:hover:bg-[#12121A] transition-colors print:hover:bg-transparent">
                                          ...
                                          <td className="p-3 text-gray-800 dark:text-gray-200 print:text-gray-800">
                                            <span className="bg-gray-100 dark:bg-[#111827] text-gray-600 dark:text-gray-300 px-2 py-0.5 rounded text-[10px] font-bold print:bg-gray-100 print:text-gray-600">
                                              {e.category || '-'}
                                            </span>
                                          </td>
                        ...
                        <div className="pt-8 mt-12 border-t border-gray-200 flex justify-between items-center text-xs text-gray-500">
                           <p>تم استخراج هذا الكشف آلياً من منصة Fox Tech ولا يحتاج إلى ختم.</p>
                           <p>توقيع الإدارة: ..............................</p>
                        </div>
                      </>
                    );
