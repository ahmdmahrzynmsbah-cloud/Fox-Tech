      ...
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-8 border border-gray-200 dark:border-slate-800 shadow-sm space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl text-xs font-black bg-gradient-to-r from-cyan-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 hover:scale-105 active:scale-95 text-white transition-all flex items-center justify-center gap-1.5 cursor-pointer border-0"
          >
        ...
        {activeFormType === 'details' ? (
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 flex gap-3 items-start text-right">
              ...
              <div className="text-xs text-amber-600 dark:text-amber-400 font-bold leading-relaxed">
                ...
                <ul className="list-decimal list-inside space-y-1">
                  ...
                  <li>اضغط على زر <span className="font-black text-sky-600 dark:text-cyan-400">"ابدأ عملية الشحن والتحويل"</span> بالركن الأيسر العلوي لتسجيل بيانات تحويلك وإرفاق الصورة.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in duration-300 text-right">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-[#0D121F] border border-gray-200 dark:border-slate-800 rounded-2xl px-5 py-3.5 outline-none focus:ring-2 focus:ring-sky-500 dark:focus:ring-cyan-400 dark:text-white font-mono font-black text-base"
                ...
                {!imageBase64 ? (
                  <div className="relative group cursor-pointer">
                    <input
                      ...
                      disabled={isSubmitting}
                    />
                    <div className="w-full bg-gray-50 dark:bg-[#0D121F] hover:bg-gray-100 dark:hover:bg-[#1A1A24]/50 border-2 border-dashed border-gray-200 dark:border-slate-800 rounded-2xl py-3.5 px-4 text-center transition-all flex items-center justify-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-sky-500/10 dark:bg-cyan-400/10 flex items-center justify-center text-sky-600 dark:text-cyan-400 group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex items-center justify-between p-3 bg-sky-500/5 dark:bg-cyan-400/5 border border-sky-500/20 dark:border-cyan-400/20 rounded-2xl relative overflow-hidden">
                    <div className="flex items-center gap-2.5 z-10">
                      ...
                      <div className="text-right">
                        <p className="text-xs font-black text-sky-600 dark:text-cyan-400">تم إرفاق الإيصال بنجاح</p>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-cyan-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500 text-white font-black py-4 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95 disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
        ...
        {loadingRequests ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {requests.map((req) => (
              <div 
                key={req.id} 
                className="p-5 rounded-2xl border border-gray-100 dark:border-slate-800/50 bg-gray-50/30 dark:bg-[#0D121F]/30 flex justify-between items-start gap-4 relative overflow-hidden hover:shadow-md transition-all duration-300"
              >
