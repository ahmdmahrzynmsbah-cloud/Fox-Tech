  ...
  if (loading) {
    return (
      <div className="flex justify-center p-8">
        <div className="w-8 h-8 border-4 border-sky-500 dark:border-cyan-400 border-t-transparent rounded-full animate-spin"></div>
      </div>
    );
  }
      ...
      <div className="bg-gray-50 dark:bg-[#090D16] p-6 rounded-2xl border border-gray-200 dark:border-slate-800">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-right">
            <thead>
              <tr className="border-b border-gray-200 dark:border-slate-800 text-gray-500 dark:text-gray-400 text-sm">
