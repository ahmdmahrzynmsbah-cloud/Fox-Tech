...
export default function AdminCoursesPanel() {
  ...
  if (viewingStudents) {
    return (
      <div className="space-y-6 text-right font-sans" dir="rtl">
        {/* Top Header Card */}
        <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-150 dark:border-slate-800 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="bg-sky-500/5 dark:bg-cyan-400/5 px-4 py-2.5 rounded-2xl border border-sky-500/10 dark:border-cyan-400/10 font-bold text-xs text-sky-600 dark:text-cyan-400 self-stretch sm:self-auto text-center">
  ...
  return (
    <div className="space-y-6 text-right" dir="rtl">
      ...
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-150 dark:border-slate-800 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-sky-600 dark:text-cyan-400">
      ...
      {/* Control Filters Bar */}
      <div className="bg-white dark:bg-[#111827] p-4 rounded-2xl border border-gray-150 dark:border-slate-800 flex flex-col md:flex-row items-center gap-4">
        {/* Search */}
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full pl-4 pr-10 py-2 rounded-xl text-xs bg-gray-50 dark:bg-[#090D16] text-gray-900 dark:text-white border border-gray-200 dark:border-slate-800 focus:ring-2 focus:ring-sky-500 dark:focus:ring-cyan-400 transition-all font-bold outline-none"
          />
        </div>
        ...
        <div className="w-full md:w-48">
          <select
            ...
            className="w-full px-3 py-2 rounded-xl text-xs bg-gray-50 dark:bg-[#090D16] text-gray-900 dark:text-white border border-gray-200 dark:border-slate-800 focus:ring-2 focus:ring-sky-500 dark:focus:ring-cyan-400 transition-all font-bold outline-none cursor-pointer"
          >
      ...
      {/* Courses List */}
      {loading ? (
        <div className="text-center py-24 bg-white dark:bg-[#111827] rounded-3xl border border-gray-150 dark:border-slate-800 shadow-sm">
          <div className="w-10 h-10 border-4 border-sky-500 dark:border-cyan-400 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          ...
          {filteredCourses.map(course => {
            ...
            return (
              <motion.div
                layout
                key={course.id}
                className={`bg-white dark:bg-[#111827] rounded-2xl border transition-all flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md ${
                  !isActive ? 'border-red-200 dark:border-red-950/40 bg-red-50/5 dark:bg-red-950/5' : 'border-gray-150 dark:border-slate-800/60'
                }`}
              >
                {/* Course Banner Image & Tags */}
                <div className="h-40 bg-gray-100 dark:bg-[#090D16] relative overflow-hidden shrink-0">
                  {course.imageUrl ? (
                ...
                <div className="p-4 border-t border-gray-150 dark:border-slate-800/40 flex gap-2 shrink-0 bg-gray-50/50 dark:bg-[#1E1E2B]/30">
            ...
            >
              ...
              <form onSubmit={handleSavePrice} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-4 pr-12 py-2.5 rounded-xl bg-gray-50 dark:bg-[#090D16] text-gray-900 dark:text-white border border-gray-200 dark:border-slate-800 focus:ring-2 focus:ring-sky-500 dark:focus:ring-cyan-400 text-sm font-bold outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-3 justify-end pt-2">
                  <button
                    type="submit"
                    className="px-5 py-2.5 bg-sky-600 dark:bg-cyan-500 text-white hover:bg-sky-700 dark:hover:bg-cyan-600 rounded-xl font-black text-xs transition-all cursor-pointer"
                  >
                    حفظ السعر الجديد
                  </button>
                  <button
