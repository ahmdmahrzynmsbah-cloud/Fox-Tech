...
export default function TeachersSearchList({ userData }: TeachersSearchListProps) {
  ...
  const teacherStats = useMemo(() => {
    ...
    teachers.forEach(t => {
      ...
      const averageRating = ratingCount > 0 ? parseFloat((ratingSum / ratingCount).toFixed(1)) : 4.1; // Decent default
      ...
      <AnimatePresence mode="wait">
        {!selectedTeacher ? (
          ...
          >
            ...
            {/* Filters panel */}
            <div className="bg-white dark:bg-[#111827] p-5 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
              {/* Search input */}
              <div className={`relative ${userData?.grade ? 'md:col-span-7' : 'md:col-span-5'}`}>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl pr-12 pl-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 transition-colors text-sm font-bold"
                />
              </div>
              ...
              <div className={`relative ${userData?.grade ? 'md:col-span-4' : 'md:col-span-3'}`}>
                ...
                <select
                  ...
                  className="w-full bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-xl pr-10 pl-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 transition-colors text-xs font-black appearance-none"
                >
            ...
            <div className="flex justify-between items-center px-2">
              ...
              {selectedGrade && (
                <span className="text-xs font-black text-sky-600 dark:text-cyan-400 bg-sky-500/10 dark:bg-cyan-400/10 py-1.5 px-3.5 rounded-xl border border-transparent flex items-center gap-1.5 shadow-sm">
            ...
            {filteredTeachers.length === 0 ? (
              <div className="bg-white dark:bg-[#111827] rounded-3xl p-16 text-center border border-gray-200 dark:border-slate-800 shadow-sm">
                <div className="w-16 h-16 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                {filteredTeachers.map((teacher, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      whileHover={{ y: -4 }}
                      className="bg-white dark:bg-[#111827] rounded-2xl border border-gray-200 dark:border-slate-800 shadow-sm p-6 flex flex-col justify-between hover:shadow-md transition-all duration-200 relative group"
                    >
                      {/* Teacher Top Info */}
                      <div className="space-y-4">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="space-y-1 min-w-0">
                            <h3 className="text-base font-black text-gray-900 dark:text-white truncate group-hover:text-sky-600 dark:group-hover:text-cyan-400 transition-colors">
                              {teacher.name || 'الأستاذ'}
                            </h3>
                            {/* Subject badge */}
                            <span className="inline-block bg-blue-50 text-sky-600 dark:bg-blue-950/40 dark:text-blue-400 border border-blue-100 dark:border-blue-900/50 py-0.5 px-2.5 rounded-lg text-[10px] font-black">
                        ...
                        {Array.isArray(teacher.teachingGrades) && teacher.teachingGrades.length > 0 && (
                          <div className="flex flex-wrap gap-1 pt-1">
                            {teacher.teachingGrades.map((g, i) => (
                              <span key={i} className="text-[9px] font-black bg-gray-100 dark:bg-[#090D16] text-gray-500 dark:text-gray-400 px-2 py-0.5 rounded-md">
                                {g}
                              </span>
                            ))}
                          </div>
                      ...
                      <div className="mt-6 pt-4 border-t border-gray-100 dark:border-slate-800 space-y-4">
                        <div className="grid grid-cols-3 gap-1 text-center bg-gray-50 dark:bg-[#090D16]/30 p-2.5 rounded-xl">
                          <div>
                          ...
                          <div className="border-x border-gray-200/50 dark:border-gray-800/50">
                            ...
                            <span className="text-sm font-black text-sky-600 dark:text-cyan-400">{stats.totalStudents}</span>
                          </div>
                          <div>
          ...
          >
            ...
            <div className="bg-white dark:bg-[#111827] p-6 md:p-8 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-right">
                ...
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                    ...
                    <span className="bg-[#00B4D8]/10 text-sky-600 dark:bg-[#D4AF37]/10 dark:text-cyan-400 border border-transparent py-0.5 px-3 rounded-full text-xs font-black">
              ...
              {/* Summary Stats */}
              <div className="flex gap-4 w-full md:w-auto border-t md:border-t-0 pt-4 md:pt-0 border-gray-100 dark:border-slate-800">
                <div className="bg-gray-50 dark:bg-[#090D16]/30 p-4 rounded-2xl flex-1 text-center md:min-w-[110px]">
                ...
                <div className="bg-gray-50 dark:bg-[#090D16]/30 p-4 rounded-2xl flex-1 text-center md:min-w-[110px]">
                  ...
                  <span className="text-lg font-black text-sky-600 dark:text-cyan-400">
                ...
                {selectedTeacherCourses.map((course, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-white dark:bg-[#111827] rounded-2xl overflow-hidden shadow-sm border border-gray-200 dark:border-slate-800 group hover:shadow-md transition-all flex flex-col h-full relative"
                    >
                      ...
                      <div className="h-44 relative overflow-hidden bg-gray-100 dark:bg-[#222230]">
                        ...
                        {/* Grade tag */}
                        <div className="absolute top-3 left-3 bg-white/90 dark:bg-black/80 backdrop-blur-sm px-2.5 py-1 rounded-lg text-[10px] font-black text-sky-600 dark:text-cyan-400 shadow-sm">
                          {course.grade}
                        </div>
                      </div>
                      ...
                      <div className="p-5 flex-1 flex flex-col justify-between">
                        ...
                        {/* Middle Stats badges */}
                        <div className="grid grid-cols-2 gap-2 my-4 pt-3 border-t border-gray-50 dark:border-slate-800 text-right">
                          ...
                          <Link
                            ...
                            className={`px-4 py-2 rounded-xl text-xs font-black transition-all ${
                              isEnrolled
                                ...
                                : 'bg-[#00B4D8]/10 text-sky-600 hover:bg-[#00B4D8] hover:text-white dark:bg-[#D4AF37]/10 dark:text-cyan-400 dark:hover:bg-[#D4AF37] dark:hover:text-gray-900'
                            }`}
                          >
