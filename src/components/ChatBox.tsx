...
export const ChatBox: React.FC<ChatBoxProps> = ({ userData, linkedStudent }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-[#0077B6] to-[#00B4D8] dark:from-[#1A1A24] dark:to-[#222232] p-5 sm:p-6 rounded-2xl text-white shadow-md relative overflow-hidden border border-white/10 dark:border-slate-800">
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-white/15 dark:bg-[#D4AF37]/15 backdrop-blur-md border border-white/20 dark:border-cyan-500/30 flex items-center justify-center shrink-0 text-white dark:text-cyan-400 shadow-sm">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-[11px] bg-white/20 dark:bg-[#D4AF37]/20 text-white dark:text-cyan-400 px-2.5 py-0.5 rounded-full border border-white/20 dark:border-cyan-500/30 font-bold">
                  التواصل المباشر
                </span>
              </div>
          ...
          <div className="shrink-0 pt-2 sm:pt-0">
            <button
              ...
              className="w-full sm:w-auto bg-white text-sky-700 dark:bg-[#D4AF37] dark:text-[#0D0D12] hover:bg-gray-100 dark:hover:bg-[#B8860B] px-4 py-2.5 rounded-xl font-black text-xs sm:text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95"
            >
      ...
      {/* Main Control Panel */}
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-4 sm:p-6 border border-gray-200 dark:border-slate-800 shadow-sm space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-gray-100 dark:border-slate-800">
          ...
          <div className="relative min-w-[240px]">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2 rounded-2xl bg-gray-50 dark:bg-[#252538] border border-gray-200 dark:border-slate-800 text-xs font-bold text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 transition-all"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="py-16 text-center flex flex-col items-center justify-center space-y-3 border-2 border-dashed border-gray-200 dark:border-slate-800 rounded-3xl p-6">
                ...
                return (
                  <motion.div
                    ...
                    className={`p-5 rounded-2xl border transition-all relative group ${
                      !isRead && !isSender
                        ? 'bg-sky-500/5 dark:bg-cyan-400/5 border-sky-500/30 dark:border-cyan-400/30 shadow-sm'
                        : 'bg-white dark:bg-[#1F1F2C] border-gray-200 dark:border-slate-800'
                    }`}
                  >
                    {/* Unread indicator ribbon */}
                    {!isRead && !isSender && (
                      <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-sky-600 dark:bg-cyan-500 text-white text-[10px] font-black px-2.5 py-1 rounded-full shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                      ...
                      {/* Card Actions */}
                      <div className="flex items-center gap-2 self-end sm:self-center shrink-0 border-t sm:border-t-0 pt-3 sm:pt-0 border-gray-100 dark:border-slate-800">
                        ...
                        {!isSender && (
                          <button
                            ...
                            className="px-3 py-1.5 bg-[#00B4D8]/10 text-sky-600 dark:bg-[#D4AF37]/10 dark:text-cyan-400 hover:bg-[#00B4D8] hover:text-white dark:hover:bg-[#D4AF37] dark:hover:text-[#0D0D12] rounded-xl text-xs font-bold transition-all flex items-center gap-1.5"
                          >
        ...
        {isComposeOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md">
            <motion.div
              ...
              className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 max-w-xl w-full shadow-2xl relative space-y-6 max-h-[90vh] overflow-y-auto custom-scrollbar"
            >
              {/* Close button */}
              <button
              ...
              <div className="flex items-center gap-3 border-b border-gray-100 dark:border-slate-800 pb-4">
                <div className="p-3 bg-[#00B4D8]/10 text-sky-600 dark:bg-[#D4AF37]/10 dark:text-cyan-400 rounded-2xl">
              ...
              <div className="space-y-4">
                ...
                {recipientType === 'role_group' && (
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full p-3 rounded-2xl bg-gray-50 dark:bg-[#252538] border border-gray-200 dark:border-slate-800 text-xs font-bold text-gray-900 dark:text-white"
                    >
                ...
                {recipientType === 'user' && (
                  <div className="space-y-3 bg-gray-50/80 dark:bg-[#151520] p-4 rounded-2xl border border-gray-200 dark:border-slate-800">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      ...
                      <span className="text-[11px] font-bold text-sky-600 dark:text-cyan-400 bg-sky-500/10 dark:bg-cyan-400/10 px-2.5 py-1 rounded-full w-fit">
                        تم تحديد {selectedUserIds.length} مستخدم
                      </span>
                    </div>

                    {/* Role Filter Tabs */}
                    <div className="flex flex-wrap gap-1.5 border-b border-gray-200 dark:border-slate-800 pb-2">
                      <button
                        type="button"
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          className="w-full pr-9 pl-3 py-2 rounded-xl bg-white dark:bg-[#252538] border border-gray-200 dark:border-slate-800 text-xs font-bold text-gray-900 dark:text-white focus:outline-none focus:border-sky-500"
                        />
                      </div>
                      <button
                        type="button"
                        onClick={handleSelectAllFiltered}
                        className="px-3 py-2 bg-white dark:bg-[#252538] hover:bg-gray-100 dark:hover:bg-[#2D2D3D] border border-gray-200 dark:border-slate-800 text-gray-700 dark:text-gray-300 rounded-xl text-xs font-extrabold shrink-0 transition-all cursor-pointer"
                      >
                          ...
                          return (
                            <div
                              ...
                              className={`p-2.5 rounded-xl border transition-all cursor-pointer flex items-center justify-between gap-3 ${
                                isSelected
                                  ? 'bg-sky-500/10 dark:bg-cyan-400/10 border-sky-500 dark:border-cyan-400 shadow-sm'
                                  : 'bg-white dark:bg-[#222232] border-gray-200 dark:border-slate-800 hover:border-gray-300 dark:hover:border-gray-600'
                              }`}
                            >
                              <div className="flex items-center gap-2.5 min-w-0">
                                <div className={`w-5 h-5 rounded-md border flex items-center justify-center shrink-0 transition-all ${
                                  isSelected
                                    ? 'bg-sky-600 dark:bg-cyan-500 border-transparent text-white'
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full p-3 rounded-2xl bg-gray-50 dark:bg-[#252538] border border-gray-200 dark:border-slate-800 text-xs font-bold text-gray-900 dark:text-white focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500"
                    required
                  ></textarea>
                </div>
                ...
                <button
                  ...
                  disabled={sending}
                  className="w-full py-3.5 bg-sky-600 dark:bg-cyan-500 text-white font-black text-sm rounded-2xl shadow-lg hover:bg-sky-700 dark:hover:bg-cyan-600 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {sending ? (
                    <>
