...
export default function InteractiveSchedule({ db, userData, coursesList }: InteractiveScheduleProps) {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <AnimatePresence>
        {activeAlert && (
          <motion.div
            ...
            className="bg-gradient-to-r from-[#0A102E] via-[#10194E] to-[#152368] text-white p-5 rounded-3xl shadow-xl flex flex-col md:flex-row items-center justify-between gap-4 border border-[#D4F800]/30 relative overflow-hidden"
          >
            {/* Absolute decorative glow circles */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4F800]/10 rounded-full blur-2xl"></div>
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/10 rounded-full blur-xl"></div>

            <div className="flex items-center gap-4 z-10">
              <div className="w-12 h-12 rounded-full bg-white/10 border border-[#D4F800]/40 flex items-center justify-center shrink-0">
                <Clock className="w-6 h-6 text-[#D4F800] animate-spin" style={{ animationDuration: "12s" }} />
              </div>
              <div>
      ...
      <div className="bg-white dark:bg-[#0A102E] p-6 rounded-3xl border border-gray-200 dark:border-white/10 flex flex-col lg:flex-row lg:items-center justify-between gap-4 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-3 shrink-0">
          {userData?.role === "teacher" && events.length > 0 && (
            <button
              ...
              className="bg-red-50 hover:bg-red-100 dark:bg-red-900/20 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 text-xs font-black px-4 py-2.5 rounded-2xl flex items-center gap-2 transition-all cursor-pointer"
            >
          ...
          {userData?.role === "teacher" && (
            <button
              ...
              className="bg-[#D4F800] hover:bg-[#c2e400] text-[#0A102E] text-xs font-black px-4 py-2.5 rounded-2xl flex items-center gap-2 shadow-md transition-all cursor-pointer"
            >
          ...
          {/* Toggle View */}
          <div className="bg-slate-100 dark:bg-[#070C22] p-1 rounded-2xl flex border border-gray-200 dark:border-white/10">
            <button
              onClick={() => setActiveView("calendar")}
              className={`px-3 py-1.5 rounded-xl text-xs font-black transition-all cursor-pointer ${
                activeView === "calendar"
                  ? "bg-[#D4F800] text-[#0A102E] shadow-sm"
        ...
        {showAddForm && userData?.role === "teacher" && (
          ...
          >
            <form
              ...
              className="bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-100 dark:border-slate-800 space-y-4 shadow-sm"
            >
              <div className="border-b border-gray-100 dark:border-slate-800 pb-3 mb-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full text-xs font-bold p-3 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl focus:border-sky-500 dark:focus:border-cyan-500 outline-none"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full text-xs font-bold p-3 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl focus:border-sky-500 dark:focus:border-cyan-500 outline-none text-right"
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full text-xs font-bold p-3 bg-gray-50 dark:bg-[#090D16] border border-gray-200 dark:border-slate-800 rounded-2xl focus:border-sky-500 dark:focus:border-cyan-500 outline-none resize-none"
                />
              </div>
      ...
      {loading ? (
        <div className="p-12 text-center bg-white dark:bg-[#111827] rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm">
        ...
        (() => {
          ...
          return (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 font-sans">
              ...
              <div className="lg:col-span-7 bg-white dark:bg-[#111827] p-6 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col justify-between">
                <div>
                  {/* Calendar Navigation Header */}
                  <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-50 dark:border-slate-800/50">
                    <button
                      type="button"
                    ...
                    <h3 className="text-base font-black text-gray-900 dark:text-white flex items-center gap-2">
                      <CalendarIcon className="w-5 h-5 text-sky-600 dark:text-cyan-400" />
                  ...
                  <div className="grid grid-cols-7 gap-1 sm:gap-2 text-center mb-2">
                    {daysOfWeekAr.map(dayName => {
                      const shortName = dayName === 'السبت' ? 'س' : dayName === 'الأحد' ? 'ح' : dayName === 'الإثنين' ? 'ن' : dayName === 'الثلاثاء' ? 'ث' : dayName === 'الأربعاء' ? 'ر' : dayName === 'الخميس' ? 'خ' : 'ج';
                      return (
                        <div key={dayName} className="text-xs font-black text-gray-400 dark:text-gray-500 py-1 sm:py-2">
                    ...
                    {calendarCells.map((cell, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`aspect-square rounded-xl flex flex-col items-center justify-center relative w-full h-full transition-all cursor-pointer group ${
                            isSelected
                              ? "bg-cyan-50 dark:bg-cyan-950/40 text-cyan-700 dark:text-cyan-400 ring-2 ring-cyan-500 dark:ring-cyan-400 ring-inset"
                              : isToday
                              ? "bg-sky-50/50 dark:bg-sky-900/20 text-sky-600 dark:text-sky-400 ring-1 ring-sky-300 dark:ring-sky-700/50 ring-inset"
                              : "bg-gray-50/50 hover:bg-gray-100 dark:bg-[#0D121F]/50 dark:hover:bg-[#20202D] text-gray-800 dark:text-gray-200 border border-gray-100/50 dark:border-slate-800/50"
                          }`}
                        >
                          ...
                          {dayEvents.length > 0 && (
                            <div className="flex items-center justify-center gap-0.5 mt-0.5">
                              {dayEvents.length <= 3 ? (
                                dayEvents.map((ev, i) => (
                                  <span key={i} className={`w-1.5 h-1.5 rounded-full ${ev.type === 'exam' ? 'bg-red-500' : ev.type === 'revision' ? 'bg-amber-500' : 'bg-blue-500'}`} />
                                ))
                              ) : (
                                <>
                                  ...
                                  <span className="text-[8.5px] font-black leading-none text-gray-500 dark:text-gray-400 tracking-tighter" style={{ transform: 'scale(0.85)' }}>
                                    +{dayEvents.length - 2}
                                  </span>
                                </>
                              )}
              ...
              <div className="lg:col-span-5 flex flex-col h-full space-y-4">
                <div className="bg-gray-100 dark:bg-[#1C1C28] p-4 rounded-2xl text-xs font-black border border-gray-200/50 dark:border-slate-800 flex items-center justify-between text-gray-500 dark:text-gray-400 shrink-0">
                  ...
                  <span className="bg-sky-500/20 dark:bg-cyan-400/20 text-sky-600 dark:text-cyan-400 px-2.5 py-1 rounded-lg text-[10px] font-black">
                  ...
                  {selectedDateEvents.length === 0 ? (
                    ...
                    selectedDateEvents.map((ev) => {
                      ...
                      return (
                        <div
                          key={ev.id}
                          className="bg-white dark:bg-[#111827] p-5 rounded-2xl border border-gray-100 dark:border-slate-800 hover:shadow-md transition-all space-y-3 flex flex-col justify-between"
                        >
                          ...
                          <div className="flex gap-2 items-center justify-end pt-2 border-t border-gray-50 dark:border-slate-800/50">
                            {userData?.role === "student" && (
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-xl text-[10px] font-bold border transition-all flex items-center gap-1.5 cursor-pointer ${
                                  isReminded
                                    ? "bg-[#00B4D8]/10 text-sky-700 border-sky-500/30 dark:bg-[#D4AF37]/10 dark:text-cyan-400 dark:border-cyan-500/30"
                                    : "bg-gray-50 dark:bg-[#20202D] text-gray-500 border-gray-100 dark:border-slate-800"
                                }`}
                              >
          ...
          {getUpcomingEvents().length === 0 ? (
            ...
            getUpcomingEvents().map((ev) => {
              ...
              return (
                <div 
                  key={ev.id}
                  className="bg-white dark:bg-[#111827] rounded-2xl p-6 border border-gray-100 dark:border-slate-800 hover:shadow-lg hover:border-sky-500/30 transition-all shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4"
                >
                  <div className="flex items-start gap-4 flex-1">
                    {/* Event Type Icon Indicator */}
                    <div className="w-14 h-14 rounded-2xl bg-gray-50 dark:bg-[#13131C] border border-gray-200/50 dark:border-slate-800 flex items-center justify-center shrink-0 text-gray-500 dark:text-gray-400">
                      {ev.type === "exam" ? (
                  ...
                  {/* Actions Side */}
                  <div className="flex flex-col sm:flex-row gap-3 items-center w-full md:w-auto shrink-0 border-t md:border-t-0 border-gray-100 dark:border-slate-800 pt-4 md:pt-0">
                    {/* Reminder toggle */}
                    {userData?.role === "student" && (
                      <button
                        onClick={() => handleToggleReminder(ev.id)}
                        className={`w-full sm:w-auto px-5 py-3 rounded-xl text-xs font-bold border transition-all flex items-center justify-center gap-2 ${
                          isReminded
                            ? "bg-[#00B4D8]/10 text-sky-700 border-sky-500/30 dark:bg-[#D4AF37]/10 dark:text-cyan-400 dark:border-cyan-500/30"
                            : "bg-gray-50 dark:bg-[#20202D] text-gray-500 border-gray-100 dark:border-slate-800 hover:bg-gray-100 dark:hover:bg-[#2D2D3D]"
                        }`}
                      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 bg-white dark:bg-[#111827] p-5 rounded-3xl border border-gray-100 dark:border-slate-800 space-y-2 h-fit shadow-sm">
              ...
              return (
                <button
                  ...
                  className={`w-full text-right p-3 rounded-2xl text-xs font-black transition-all flex items-center justify-between ${
                    selectedDayIdx === idx
                      ? "bg-[#00B4D8]/10 text-sky-700 dark:bg-[#D4AF37]/10 dark:text-cyan-400"
                      : "text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-[#20202D]"
                  }`}
                >
                  <span>{dayName}</span>
                  {count > 0 && (
                    <span className="bg-sky-600 dark:bg-cyan-500 text-white text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-sans font-bold">
                      {count}
                    </span>
                  )}
                </button>
          ...
          <div className="lg:col-span-3 space-y-4">
            <div className="bg-gray-100 dark:bg-[#1C1C28] p-4 rounded-2xl text-xs text-gray-500 font-black border border-gray-200/50 dark:border-slate-800 flex items-center justify-between">
              <span>عرض حصص ومواعيد يوم: <strong className="text-gray-900 dark:text-white font-black">{arabDays[selectedDayIdx]}</strong></span>
              <span className="text-[11px] text-sky-600 dark:text-cyan-400">مجموع المواعيد اليوم: {getWeeklyFilteredEvents().length}</span>
            </div>
            ...
            {getWeeklyFilteredEvents().length === 0 ? (
              ...
              getWeeklyFilteredEvents().map((ev) => {
                ...
                return (
                  <div
                    key={ev.id}
                    className="bg-white dark:bg-[#111827] p-6 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all space-y-4"
                  >
                    ...
                    <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-50 dark:border-slate-800/50 justify-between items-center">
        ...
        {eventToDelete && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-[#111827] rounded-3xl w-full max-w-md relative z-10 shadow-2xl p-8 border border-gray-100 dark:border-slate-800 text-center"
            >
