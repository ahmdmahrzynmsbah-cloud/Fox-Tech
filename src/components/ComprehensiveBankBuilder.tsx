    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto bg-black/60 backdrop-blur-sm" dir="rtl">
        <motion.div
          ...
          className="bg-gray-50 dark:bg-[#090D16] w-full max-w-5xl rounded-3xl shadow-2xl flex flex-col h-[90vh] overflow-hidden border border-gray-200 dark:border-slate-800"
        >
          {/* Header */}
          <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-[#111827] shrink-0">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-sky-500/10 dark:bg-cyan-400/10 flex items-center justify-center">
          ...
          <div className="flex-1 overflow-y-auto p-6 scroll-smooth">
            <div className="max-w-3xl mx-auto space-y-8">
              ...
              {/* Basic Details */}
              <div className="bg-white dark:bg-[#111827] rounded-2xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm space-y-5">
                <h4 className="font-black text-sm text-gray-800 dark:text-gray-200 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-lg bg-sky-500/10 dark:bg-cyan-400/10 text-sky-600 dark:text-cyan-400 flex items-center justify-center text-xs">1</span>
                  المعلومات الأساسية
                </h4>
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 dark:bg-[#222230] border border-gray-200 dark:border-slate-800 rounded-xl text-sm font-bold focus:outline-none focus:border-sky-500 dark:focus:border-cyan-500 text-gray-900 dark:text-white"
                    />
                  </div>
                  <div>
                    <label className="text-xs font-black text-gray-700 dark:text-gray-300 mb-1.5 block">
              ...
              <div className="space-y-4">
                ...
                <React.Fragment key={q.id}>
                  <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm relative group overflow-hidden">
                    <div className="absolute top-0 right-0 w-1.5 h-full bg-sky-600 dark:bg-cyan-500"></div>
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black px-2 py-1 bg-[#00B4D8]/10 text-sky-600 dark:bg-[#D4AF37]/10 dark:text-cyan-400 rounded-md">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1">
                        ...
                        <textarea
                          ...
                          className="w-full p-3 bg-gray-50 dark:bg-[#222230] border border-gray-100 dark:border-slate-800 rounded-xl text-sm font-bold text-gray-900 dark:text-white resize-none h-20 focus:outline-none focus:border-sky-500"
                        />
                      </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {q.options.map((opt, optIdx) => (
                              <div key={optIdx} className={`flex items-center gap-3 p-2 rounded-xl border ${q.correctOptionIndex === optIdx ? 'border-green-400 bg-green-50 dark:border-green-500/50 dark:bg-green-900/10' : 'border-gray-200 dark:border-slate-800 bg-white dark:bg-[#111827]'}`}>
                                <input
                                  type="radio"
                                  name={`correct_${q.id}`}
          ...
          {/* Footer */}
          <div className="p-6 border-t border-gray-100 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-[#111827] shrink-0">
