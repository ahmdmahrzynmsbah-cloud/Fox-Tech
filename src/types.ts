...
export interface PlatformSettings {
  ...
  showQuduratSection?: boolean;
  showTahsiliSection?: boolean;
  enableQuduratTahsili?: boolean;
  gradesTitle: string;
  ...
  heroAudienceTitle?: string;
  heroLaunchTitle?: string;
  heroLaunchTime?: string;
  heroCurriculumNote?: string;
  heroContentTitle?: string;
  heroContentBadge?: string;
  heroContentItems?: string[];
  heroDateDay?: string;
  heroDateMonthYear?: string;
  heroDateTime?: string;
  heroDateTag?: string;
...
export interface User {
  ...
  educationSystem?: 'general' | 'azhar' | 'baccalaureate' | string;
